this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var La = ['abayı', 'abaza', 'about', 'acsan', 'acıyı', 'adama', 'adayı', 'adedi', 'adese', 'admin',
'adını', 'afaki', 'ahead', 'ahını', 'ahşap', 'akemi', 'akort', 'alanı', 'alarm', 'alatt',
'albüm', 'aleyh', 'alkil', 'altay', 'altın', 'amber', 'ameli', 'amiss', 'analı', 'angut',
'anlam', 'anzak', 'aqşam', 'araba', 'arsal', 'asked', 'atina', 'avize', 'avond', 'avsun',
'aylar', 'ayraç', 'azize', 'azvay', 'ağman', 'ağulu', 'ağuyu', 'aşağı', 'baden', 'bahis',
'bahse', 'balak', 'balon', 'bambu', 'basaa', 'basma', 'becet', 'bedel', 'bedir', 'beech',
'bekas', 'berna', 'beste', 'betül', 'beyaz', 'beyin', 'bezik', 'biber', 'bilim', 'bilir',
'biyom', 'bluzu', 'bordo', 'bozuk', 'bulun', 'bumba', 'burma', 'burnu', 'buzlu', 'bölme',
'bölüm', 'böyle', 'böyük', 'böğür', 'büten', 'bütün', 'büyük', 'bıçkı', 'cacık', 'camın',
'cebin', 'cenup', 'cesur', 'cezir', 'cihat', 'cisim', 'cloze', 'cocos', 'combo', 'dalya',
'damla', 'danca', 'dansk', 'delgi', 'demir', 'denek', 'deniz', 'denkt', 'derin', 'dersi',
'derya', 'detay', 'devim', 'değin', 'dikes', 'dinin', 'dolar', 'domat', 'domuz', 'doğal',
'doğan', 'doğru', 'doğuş', 'dulus', 'duvar', 'duygu', 'dünya', 'efekt', 'eklem', 'ekmek',
'ekran', 'eleme', 'elişi', 'emcek', 'emcik', 'emlak', 'ercik', 'erinç', 'esmek', 'evlek',
'evren', 'eylem', 'facia', 'fakat', 'falan', 'fecre', 'fehim', 'ferah', 'fetiş', 'feyiz',
'filum', 'fiske', 'fisto', 'fulya', 'gabon', 'gamet', 'gecek', 'geliş', 'genel', 'geniz',
'geniş', 'geçiş', 'goduş', 'gölet', 'gönül', 'görgü', 'görüş', 'göğüs', 'gülüş', 'gümüş',
'güney', 'güneş', 'güreş', 'güyük', 'güçlü', 'hacet', 'haddi', 'hadis', 'hamam', 'harbi',
'hasta', 'hasım', 'hazar', 'hazır', 'helak', 'hello', 'herze', 'hicri', 'hidro', 'hüküm',
'hüzün', 'idare', 'ikmal', 'ilkah', 'imalı', 'ipucu', 'ispat', 'içmek', 'işeme', 'işrak',
'jakar', 'jeton', 'kabak', 'kadar', 'kadın', 'kahve', 'kaldı', 'kalın', 'kamış', 'kaniş',
'kanji', 'kapan', 'kappa', 'kaput', 'kargı', 'karnı', 'karşı', 'kasus', 'katar', 'katır',
'kaval', 'kayın', 'kayıp', 'kağıt', 'kefil', 'kemik', 'kerki', 'kesat', 'kesik', 'keten',
'kibar', 'kiler', 'kilit', 'killi', 'kireç', 'kiriş', 'kitap', 'kokak', 'kokma', 'kokum',
'kolcu', 'konka', 'korku', 'kosta', 'koşar', 'koşma', 'koşul', 'kralı', 'kredi', 'kulte',
'kurum', 'kutup', 'kuzey', 'kuşku', 'köfte', 'köken', 'kömüş', 'külot', 'kürek', 'küçük',
'kıllı', 'kıray', 'kısma', 'kızma', 'kışır', 'lahit', 'lahut', 'lakin', 'lamba', 'lehçe',
'levha', 'libya', 'licht', 'light', 'limon', 'lobut', 'locus', 'lüfer', 'madde', 'maden',
'madik', 'makas', 'manda', 'marya', 'masun', 'mayak', 'maşuk', 'meden', 'melel', 'meraq',
'mermi', 'mesih', 'metni', 'minci', 'mobil', 'mondo', 'motor', 'mouse', 'mumcu', 'müdür',
'mısır', 'nabız', 'nacak', 'nakil', 'nakit', 'nazlı', 'nazır', 'naçiz', 'nebat', 'nedir',
'nepal', 'nurla', 'nüzul', 'odaya', 'okuma', 'ovmak', 'oynat', 'oğlan', 'pamuk', 'parsa',
'payan', 'pazar', 'peros', 'pilav', 'polen', 'pompa', 'porto', 'prime', 'prune', 'rahat',
'rasat', 'resim', 'reşit', 'ritim', 'roman', 'rusya', 'rusça', 'röfle', 'rüküş', 'rütbe',
'saati', 'sadır', 'sahan', 'salaş', 'salih', 'salya', 'sanem', 'sanık', 'saray', 'sarka',
'satma', 'savma', 'saygı', 'sayha', 'secde', 'sefir', 'sense', 'sepet', 'sevda', 'seziş',
'sezon', 'seçim', 'sinek', 'sinik', 'sitte', 'siyah', 'sofya', 'solid', 'soluk', 'somya',
'sorum', 'soude', 'soylu', 'stash', 'sudan', 'sumak', 'sunta', 'surat', 'suyun', 'sökün',
'söğüt', 'söğüş', 'sümük', 'sürek', 'sürüş', 'süzme', 'sıfat', 'sıkça', 'sığma', 'taben',
'tablo', 'taldı', 'taleb', 'talım', 'tamik', 'taraf', 'tarik', 'tasma', 'tasım', 'tatlı',
'tayfı', 'teker', 'tekil', 'telaş', 'temek', 'temel', 'tengo', 'tensi', 'testi', 'teşne',
'tigin', 'tokat', 'tokaç', 'tonga', 'topla', 'toplu', 'trans', 'turaç', 'turks', 'under',
'unsur', 'usanç', 'uyari', 'uyarı', 'uymak', 'uysak', 'vakit', 'vargı', 'vatan', 'vento',
'venüs', 'verre', 'yabgu', 'yakin', 'yalak', 'yamuk', 'yankı', 'yapay', 'yapma', 'yapış',
'yarık', 'yarım', 'yatma', 'yatık', 'yazık', 'yedek', 'yemek', 'yemen', 'yengi', 'yerey',
'yitme', 'yokum', 'yolak', 'yolcu', 'yolçu', 'yonca', 'yontu', 'yosun', 'yufka', 'yular',
'yumru', 'yunan', 'yusam', 'yörük', 'zabıt', 'zahir', 'zahit', 'zayıf', 'zemin', 'zenci',
'zikri', 'zirve', 'zuhur', 'çalış', 'çanak', 'çanta', 'çaput', 'çaşıt', 'çenar', 'çepel',
'çigan', 'çiler', 'çince', 'çinli', 'çizgi', 'çiğit', 'çocuk', 'çolak', 'çözme', 'çıkla',
'öksüz', 'öncek', 'önlük', 'öpmek', 'öreke', 'örgin', 'örnek', 'örttü', 'övünç', 'özbek',
'özegi', 'üfleç', 'üreme', 'üryan', 'üstat', 'ıssız', 'ışıma', 'şafak', 'şahan', 'şahit',
'şahıs', 'şakak', 'şarkı', 'şerha', 'şiiri', 'şinik', 'şorca', 'şöyle']
;
