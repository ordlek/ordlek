this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var La = ['aarau', 'abild', 'acces', 'adept', 'adlen', 'adlet', 'adlyt', 'adula', 'affej', 'afhug',
...
'zappa', 'zappe', 'zarer', 'zefyr', 'zelot', 'zenit', 'zinke', 'zobel', 'zoome']
,
Ta=['aauug', "abb's", "abc's", 'adict', "aeg's", "agf's", "aim's", "anc's",
"aof's", 'asean', 'aages', 'aagot', 'aakes', 'aaron', 'aasas', 'aases', 'abbas', 'abbie',
'abdel', 'abdul', 'abell', 'abels', 'abild', 'achim', 'acton', 'adams', 'adane', 'addas',
'addie', 'addys', 'adeas', 'adela', 'adele', 'adens', 'adias', 'adies', 'adils', 'adina',
'adine', 'adolf', 'adser', 'adwan', 'adèle', 'agate', 'agdas', 'aggas', 'agges', 'aggis',
'agnar', 'agnas', 'agner', 'agnes', 'agnys', 'agnès', 'ahmed', 'aicha', 'aidas', "aies'",
'aikos', 'ailas', 'ailis', 'aimas', 'aimis', 'aimys', 'aimèe', 'ainas', 'ainos', 'aisha',
"ajes'", 'akims', 'akita', 'aksel', 'akton', 'alaia', 'alain', 'alans', 'alban', 'albas',
'albin', 'aldos', 'alecs', 'aleia', 'aleks', 'aleta', 'alett', "alex'", 'alexa', 'alfas',
'algea', 'alger', 'algot', 'algys', 'alias', 'alice', 'alida', 'alina', 'aline', "alis'",
'alisa', 'alise', 'alita', "aliz'", 'allah', 'allan', 'allen', 'aller', 'allie', 'allis',
'allys', 'almar', 'almas', 'almer', 'alois', 'alona', 'alpha', 'alvar', 'alvas', 'alver',
'alvin', 'amand', 'amdis', 'amina', 'amine', 'amira', 'amola', 'amund', 'anaya', 'ancia',
'andis', 'andre', 'andry', 'andré', 'andys', 'anete', 'anett', 'angel', 'angul', 'angus',
'anias', 'anica', 'anick', 'anies', 'aniet', 'anika', 'aniki', 'anina', 'anine', 'anisa',
'anise', 'anita', 'anjas', 'ankas', 'anker', 'ankes', 'ankie', 'anlis', 'annan', 'annas',
'annes', 'annet', 'annia', 'annie', 'annik', 'annis', 'annli', 'annys', 'anouk', 'anses',
'antes', 'antia', 'antje', 'anton', 'antía', 'anyas', 'anées', 'apple', 'aquas', 'arams',
'arent', 'ariks', 'arild', 'arina', 'arise', 'arken', 'arlas', 'arlys', 'armin', 'arnas',
'arndt', 'arnes', 'arnis', 'arnos', 'arnth', 'arnts', 'arons', 'artur', 'arved', 'arvid',
'arvin', 'asbæk', 'asdis', 'asgar', 'asger', 'asien', 'asjas', 'asker', 'askes', 'askil',
'aslak', 'aslas', 'asløg', 'asmus', 'asras', 'asser', 'assia', 'assis', 'astas', 'astor',
'athen', 'atles', 'atlis', "atos'", 'attes', 'audun', 'augos', 'auken', 'aukje', 'avlum',
'axels', 'aylil', 'aymas', 'aynas', 'ayoes', 'ayses', "bkh's", 'baard', 'bagga', 'bagge',
'bahne', 'bakis', 'banes', 'barba', 'barny', 'barry', 'barsø', 'barts', 'beata', 'beate',
'bebes', 'becca', 'becky', 'bella', 'bells', 'benda', 'bende', 'bendt', 'bendy', 'benes',
'bengt', 'benin', 'benja', 'benna', 'benne', 'benni', 'benno', 'benns', 'benny', 'benta',
'bente', 'benth', 'bents', 'bentt', 'berds', 'berit', 'berna', 'bernd', 'berni', 'berno',
'bernt', 'berny', 'berry', 'berta', 'berte', 'berto', 'berts', 'beryl', "bess'", 'beths',
'betje', 'betri', 'betsy', 'bette', 'betts', 'betty', 'betzy', 'beyer', 'bibas', 'bibba',
'bibbi', 'bibis', 'biddy', 'bilka', 'bille', 'bills', 'billy', 'binas', 'bines', 'bings',
'binie', 'birde', 'birge', 'birit', 'birka', 'birks', 'birla', 'birna', 'birta', 'birte',
'bitja', 'bitta', 'bjork', 'björn', 'bjørg', 'bjørk', 'bjørn', 'blair', "blas'", 'blias',
'bobbi', 'bobby', 'bodes', 'bodil', 'bodos', 'boels', 'bogøs', 'bohrs', 'boies', 'bojes',
'bonde', 'bondo', 'bones', 'bonna', 'bonne', 'bonno', 'bonny', 'boris', 'boyds', 'boyes',
'brahe', 'brams', 'brede', 'brett', 'brian', 'brina', 'brion', 'brisa', 'brita', 'brith',
'brits', 'britt', 'brors', 'bruce', 'bruno', 'bruun', 'bruus', 'bryan', 'bryde', 'bugge',
'buris', 'burma', 'bushs', 'buurs', 'byrge', 'bågøs', 'bøjes', 'børge', 'børre', 'bülow',
'c-fil', "ceus'", "cia's", 'caias', 'cajas', 'cajus', 'calla', 'calle', 'camma', 'camre',
'canas', 'canja', 'canna', 'caria', 'carin', 'caris', 'carit', 'carla', 'carli', 'carlo',
'carls', 'carly', 'carna', 'carol', 'cates', 'cathe', 'cathy', 'catia', 'catja', 'catos',
'cayas', 'cecil', 'celia', 'celie', 'cendy', 'centa', 'chano', 'cheri', 'chias', 'chico',
'chiko', 'chile', 'chili', 'chloe', 'chres', 'chris', 'ciano', 'cilas', 'cilia', 'cilie',
'cilla', 'cille', 'cimmi', 'cinda', 'cindi', 'cindy', 'cinna', 'cinne', 'ciras', 'cisse',
'cissy', 'citas', 'citha', 'claes', 'clara', 'clare', 'clari', 'clark', "clas'", 'claus',
'clavs', 'cleas', 'cleos', 'cliff', 'clint', 'clive', 'cloes', 'clyde', 'cocos', 'codan',
'colin', 'congo', 'conja', 'conni', 'conny', 'coras', 'cordt', 'corna', 'corts', 'corty',
"cris'", 'cubas', 'cunos', 'curds', 'curts', 'cyril', 'cæsar', 'd-dur', "dbu's", "ddr's",
"dgu's", "dkp's", 'dkuug', "dsb's", "dsl's", "dtu's", 'dacia', 'daens', 'dafne', 'daghs',
'dagny', 'dahls', 'daimi', 'daisi', 'daisy', 'dalai', 'dalby', 'dalum', 'danas', 'dania',
'danis', 'danja', 'danna', 'danni', 'danns', 'danny', 'dante', 'danys', 'dargo', 'dario',
'daves', 'david', 'davie', 'davys', 'dawns', 'deans', 'delia', 'denas', 'denia', 'denis',
'deniz', 'denja', 'denni', 'denny', 'derek', 'deres', 'derri', 'derry', 'devas', 'devin',
'diana', 'diane', 'dians', 'dichs', 'dicks', 'dicky', 'dicte', 'didas', 'didda', 'didde',
'diddi', 'didos', 'diego', 'dikte', 'dimys', 'dinah', 'dinas', 'dines', 'dinna', 'dinne',
'dinny', 'dinos', 'diona', 'dions', 'dirch', 'dirks', 'disas', 'ditta', 'ditte', "ditz'",
'divus', 'dodos', 'dolly', 'donna', 'donni', 'donny', 'doras', 'dorde', 'doria', 'doris',
'dorit', 'dorte', 'dotta', 'doyle', 'dreas', 'drejø', "dres'", 'drevs', 'drine', 'drude',
'druna', 'dubai', 'dunia', 'dunja', 'durup', 'dybæk', 'dylan', 'dynes', "elg's", "epo's",
"esa's", 'earls', 'ebbas', 'ebbes', 'ebbis', 'ebers', 'eddas', 'eddis', 'eddys', 'edele',
'edels', 'edgar', 'edita', 'edith', 'edits', 'edlas', 'edlef', 'edles', 'edlys', 'edmas',
'edmée', 'ednas', 'eduas', 'edvia', 'edvin', 'edwin', 'effie', 'egans', 'egert', 'egild',
'egill', 'egils', 'egina', 'egons', 'egund', 'eguns', 'ehler', 'eides', 'eigil', 'eikes',
'eilas', 'eilef', 'eiler', 'eilev', 'eilif', 'einar', 'einas', 'einer', 'einos', 'eirik',
'eisas', 'eitel', 'eivin', 'eivor', 'ejbys', 'ejgil', 'ejlar', 'ejlas', 'ejlef', 'ejler',
'ejlev', 'ejlif', 'ejnar', 'ejnas', 'ejner', 'ejnos', 'ejolf', 'ejsas', 'ejvin', 'elafs',
'elans', 'elavs', 'elefs', 'elena', 'elene', 'eleni', 'elert', 'eleta', 'elfis', 'elgar',
'elgas', 'elian', 'elias', 'elice', 'elida', 'elies', 'elifs', 'elina', 'eline', 'elins',
'eliot', 'elisa', 'elise', 'elita', 'elith', 'elits', 'elius', 'eliza', 'elkas', 'elkes',
'ellas', 'ellen', 'elles', 'ellie', 'ellis', 'ellys', 'elmar', 'elmas', 'elmer', 'elmos',
'elmys', 'elnas', 'elnys', 'elofs', 'elons', 'elsas', 'elses', 'elsie', 'elton', 'elufs',
'elvar', 'elvas', 'elver', 'elvin', 'elvis', 'elwin', 'embla', 'emeli', 'emely', 'emiel',
'emile', 'emili', 'emils', 'emily', 'emmas', 'emmik', 'emmys', "emus'", 'enids', 'enjas',
'ennos', 'enoch', 'enoks', 'enver', 'enyas', 'enzos', 'erena', 'erene', 'erias', 'erica',
'erich', 'erick', 'erico', 'erics', 'erika', 'eriko', 'eriks', 'erins', 'erita', 'erkki',
'erlan', 'erlas', 'erlin', 'erlys', 'ernas', 'ernis', 'ernos', 'ernst', 'erons', 'errit',
'errol', 'ervin', 'erwin', 'esben', 'esger', 'esges', 'eskes', 'eskil', 'espen', 'esper',
'esrum', 'essex', 'estas', 'ester', 'estha', 'etels', 'ethan', 'ethel', 'ethla', 'ethly',
'etlar', 'etlas', 'etlys', 'ettas', 'ettie', 'ettys', 'eugen', 'evald', 'evans', 'evely',
'evens', 'evert', 'evind', 'evins', 'evita', 'ewald', 'ewans', 'ewert', 'excel', 'eylef',
'eylev', 'eylif', 'eyolf', 'eyvin', 'fabio', 'faith', 'fakse', 'falck', 'falka', 'falke',
'falks', 'fanny', 'fanøs', 'farah', 'farum', 'farup', 'fejøs', 'felia', 'felix', 'femøs',
'fenja', 'ferry', 'fijis', 'filip', 'filsø', 'finds', 'finis', 'finni', 'finns', 'fiona',
'fleur', 'flora', 'fodor', 'folke', 'frank', 'frans', 'franz', 'freda', 'frede', 'fredi',
'freds', 'fredy', 'freja', 'frejs', 'freud', 'freya', 'freys', 'fribo', 'frida', 'fride',
'frigg', 'friis', 'frilo', 'frits', 'fritz', 'frode', 'fylla', 'fänge', 'føtex', "gnu's",
'gulch', 'gabis', 'gabon', 'gabys', 'gaias', 'gaiga', 'gajas', 'ganja', 'garys', 'gaudi',
'gaute', 'gavin', 'gayas', 'geert', 'geira', 'geirs', 'gejrs', 'gelas', 'gemma', 'genas',
'genny', 'genos', 'georg', 'geran', 'gerda', 'gerds', 'gerdt', 'gerly', 'gerry', 'gerta',
'gerth', 'gerti', 'gerts', 'geske', 'getes', 'gethe', 'ghana', 'ghita', 'gians', 'gidas',
'gidda', 'gigis', 'gilas', 'gilda', 'gilla', 'ginas', 'gines', 'ginia', 'ginie', 'ginna',
'ginne', 'ginos', 'gisas', 'gisla', 'gisle', 'gitas', 'githa', 'githe', 'giths', 'gitta',
'gitte', 'gitts', 'glenn', 'glens', 'gleve', 'godik', 'gomme', 'gores', 'gorms', 'grace',
'gregs', 'greif', 'grejs', 'grenå', 'greta', 'grete', 'greve', 'griet', 'grith', 'grits',
'gritt', 'groas', 'grove', 'gudda', 'gudik', 'guido', 'gulla', 'gulli', 'gulls', 'gumme',
'gunda', 'gunde', 'gunna', 'gunne', 'gunni', 'gunns', 'gunos', 'gunta', 'gunva', 'guris',
'gurli', 'gurly', 'gwens', 'gydas', 'gylla', 'gynna', 'gyrit', 'gytas', 'gytha', 'gythe',
'gytta', 'gytte', 'göran', 'gösta', "götz'", "gøtz'", 'hagen', 'haggi', 'haiti', 'hajos',
'hakki', 'hakon', 'halla', 'hamid', 'hanna', 'hanne', 'hanni', 'hanno', 'hanny', "hans'",
'hansa', 'harda', 'hardy', 'harly', 'harri', 'harro', 'harry', 'hasan', 'hasel', 'hasle',
'hasse', 'hassi', 'hauge', 'hazel', 'hebes', 'hedas', 'hedda', 'heddi', 'heddy', 'hedis',
'hedys', 'hegen', 'hegns', 'heide', 'heidi', 'heidl', 'heika', 'heike', 'heiko', 'heile',
'heina', 'heine', 'heini', 'heino', 'heins', 'heinz', 'heise', 'hejdi', 'hejne', 'helas',
'helda', 'helen', 'helga', 'helge', 'helgi', 'helgo', 'helia', 'hella', 'helle', 'helma',
'henna', 'henni', 'henny', 'henri', 'henry', 'heras', 'heris', 'herla', 'herle', 'herma',
'herta', 'hilda', 'hilde', 'hilma', 'hinna', 'hjarn', 'hlifs', 'hobro', 'hoder', 'holds',
'holga', 'holly', 'holme', 'holms', 'holte', 'honey', 'hopes', 'horst', 'hroar', 'hrolf',
'hughs', 'hugin', 'hugis', 'hugos', 'hulda', 'husum', 'hyben', 'hygum', 'hågen', 'håkan',
'håkon', 'hårby', 'høghs', 'høgne', 'højer', 'hørby', 'hørup', "ibm's", 'ianes', 'ianis',
'ianne', 'ibbes', 'ibens', 'ibina', 'idaho', 'idunn', 'iduns', 'igors', 'ikast', 'ikeas',
'ilana', 'ilena', 'ilene', 'ilian', 'ilias', 'ilina', 'illas', 'illya', 'ilona', 'ilone',
'ilsas', 'ilses', 'ilyas', 'imran', 'india', 'ineke', "ines'", "inez'", 'ingas', 'inger',
'inges', 'ingis', 'ingos', 'ingse', 'ingun', 'inies', 'inken', 'innas', "inès'", "inèz'",
'iraks', 'irans', 'irbit', 'irela', 'irena', 'irene', 'irens', 'irina', "iris'", 'irith',
'irits', 'irjas', 'irkas', 'irkes', 'irlin', 'irmas', 'irnas', 'isaac', 'isacs', 'isaks',
'isels', 'ishøj', 'islev', 'ivalo', 'ivana', 'ivans', 'ivara', 'ivars', 'ivers', 'iwans',
'iwars', 'iwers', 'jaans', 'jacko', 'jacks', 'jacky', 'jacob', 'jades', 'jaels', 'jafet',
'jahns', 'jaime', "jais'", 'jakob', 'jalls', 'jalte', 'jamal', 'james', 'janas', 'janek',
'janes', 'janet', 'janey', 'jania', 'janie', 'janis', 'janna', 'janne', 'janni', 'janns',
'janny', 'janos', 'jansi', 'janus', 'japan', 'jappe', 'jaris', 'jarle', 'jarls', 'jarne',
'jarno', 'jaron', 'jason', 'jayne', 'jeana', 'jeane', 'jeans', 'jeddy', 'jeffi', 'jeffs',
'jeffy', 'jegor', 'jekos', 'jelva', 'jenas', 'jenda', 'jenna', 'jenni', 'jenny', "jens'",
'jeppe', 'jerik', 'jerks', 'jerne', 'jerri', 'jerry', "jess'", 'jesse', 'jesus', 'jette',
'jills', 'jimis', 'jimmi', 'jimms', 'jimmy', 'jinga', 'jings', 'joahs', 'joans', 'jocks',
'jodie', 'joels', 'joens', 'johan', 'johna', 'johni', 'johns', 'johny', "johs'", 'jokum',
'jonas', 'jonie', 'jonna', 'jonne', 'jonny', "joos'", 'joram', 'joran', 'jordy', 'jorge',
'jorid', 'jorie', 'jorns', 'jorry', 'jorst', 'jorun', 'josef', 'joshs', 'josia', 'josts',
'josua', 'josue', 'josva', 'josés', 'jovan', 'jovas', 'joyce', 'joyes', 'jozef', 'joëls',
'juana', 'juans', 'judie', 'judis', 'judit', 'judys', 'judæa', 'jukis', 'jules', 'julia',
'julie', 'julla', 'julsø', 'junas', 'junes', 'junia', 'junie', 'junni', 'juris', 'jussi',
'justa', 'justs', 'jutas', 'jutha', 'jutta', 'jyrki', 'jytas', 'jytta', 'jytte', 'jóhan',
'jøren', 'jørga', 'jørgs', 'jørks', 'jørli', 'jørna', 'jørns', 'kaare', 'kadia', 'kadja',
'kaias', 'kaino', 'kains', 'kairo', 'kaisa', 'kajas', 'kajsa', 'kaleb', 'kalis', 'kalle',
'kamma', 'kammy', 'kamos', 'kanja', 'kanna', 'kanya', 'karel', 'karen', 'karia', 'karim',
'karin', 'karis', 'karla', 'karle', 'karli', 'karlo', 'karls', 'karma', 'karna', 'karno',
'karol', 'katas', 'kates', 'katha', 'kathe', 'kathy', 'katia', 'katie', 'katja', 'katje',
'katka', 'katty', 'katya', 'katys', 'kayas', 'keans', 'kecia', 'keens', "kees'", 'keith',
'kelds', 'kelli', 'kells', 'kelly', 'kemal', 'kenan', 'kenni', 'kenno', 'kenns', 'kenny',
'kenth', 'kento', 'kents', 'kenya', 'keren', 'kerit', 'kerns', 'kerry', 'ketel', 'keths',
'ketil', 'ketta', 'kette', 'ketti', 'ketts', 'ketty', 'kevin', 'kevyn', 'kewan', 'kewin',
'kezia', 'kians', 'kicka', 'kicki', 'kield', 'kikas', 'kikis', 'kikke', 'kikki', 'kimie',
'kimis', 'kimma', 'kimmi', 'kimmo', 'kimms', 'kimmy', 'kimos', 'kinas', 'kinna', 'kinns',
'kions', 'kiras', 'kiris', 'kirit', 'kirja', 'kirsa', 'kirse', 'kirta', 'kisas', "kiss'",
'kissy', 'kitas', 'kitha', 'kitna', 'kitos', 'kitsa', 'kitta', 'kitte', 'kitti', 'kitts',
'kitty', 'kitza', 'kivas', 'kivin', 'kiwas', 'kiwin', 'kjeld', 'kjell', 'klaes', 'klara',
'klare', "klas'", 'klaus', 'klavs', 'kleas', 'kleos', 'klios', 'knuds', 'knuth', 'knuts',
'kofod', 'konja', 'konni', 'konny', 'koras', 'kords', 'korea', 'kores', 'korna', 'korts',
'kraka', 'kreis', 'kreml', 'krens', 'kreta', "kris'", 'krogh', 'kruså', 'kræns', 'krøjs',
'kuans', 'kunos', "kunz'", 'kurds', 'kurth', 'kurts', 'kyoto', 'kyras', 'kätes', 'käthe',
'kätty', 'kåres', 'kæthe', 'latex', 'lages', 'laica', 'laide', 'laika', 'laila', 'laina',
'laisa', 'laise', 'lajka', 'lajla', 'lalla', 'lanas', 'lance', 'lanes', 'langå', 'lanis',
'lanni', "laos'", 'laras', 'laris', 'larna', 'larry', "lars'", "lass'", 'lasse', 'laues',
'lauge', 'launy', 'laura', 'laure', 'lauri', 'laurs', "laus'", 'laust', 'laves', 'lavra',
'lavrs', 'lavst', 'layla', 'leahs', 'leana', 'leane', 'leans', 'lecia', 'lecks', 'ledas',
'ledna', 'leeds', 'leena', 'lehna', 'leias', 'leibs', 'leiff', 'leifs', 'leika', 'leila',
"leis'", 'leisa', 'leise', 'lejff', 'lejfs', 'lejla', 'lelas', 'lemmy', 'lenas', 'lenda',
'lenes', 'lenia', 'lenie', 'lenis', 'lenja', 'lenka', 'lenna', 'lenni', 'lenny', 'leona',
'leone', 'leons', 'lette', 'levis', 'levys', 'lewis', 'leyla', 'liams', 'liana', 'liane',
'liani', 'liann', 'liats', 'libas', 'lican', 'licas', 'licia', 'licie', 'lidas', 'lidda',
'liddi', 'liddy', 'lidia', 'lidis', 'lidys', 'liffs', "liis'", 'liisa', 'lilah', 'lilan',
'lilas', 'lilia', 'lilie', 'lilis', 'lilja', 'lilla', 'lilli', 'lills', 'lilly', 'lilse',
'lilys', 'linas', 'linda', 'lindi', 'lindy', 'linea', 'lines', 'linet', 'linka', 'linna',
'linns', 'linus', 'linux', 'lisan', 'lisas', 'lisel', 'lises', 'liset', 'lisie', 'lisis',
'lisls', "liss'", 'lissa', 'lisse', 'lissi', 'lissy', 'lista', 'lisys', 'litas', 'liten',
'litha', 'liths', 'litka', 'litta', 'litte', 'litzi', 'litzy', 'livas', 'livia', 'lizas',
'lizet', 'lizie', 'lizis', 'lizls', 'lizza', 'lizzi', 'lizzy', 'lokes', 'lolan', 'lolas',
'lolos', 'lonas', 'lones', 'loney', 'lonia', 'lonis', 'lonna', 'lonni', 'lonny', 'loras',
'lorea', 'lores', 'loris', 'lorna', 'lorry', 'lotta', 'lotte', 'lotti', 'lotty', 'lotus',
'louie', 'louis', 'lovas', 'luana', 'luane', 'luann', 'lucas', 'lucca', 'lucia', 'lucie',
'lucys', "luis'", 'luisa', 'luise', 'lukas', 'lukes', 'lulas', 'lulla', 'lulle', 'lulls',
'lulus', 'lunas', 'lunds', 'lusys', 'luths', 'lycie', 'lyder', 'lydia', 'lykka', 'lykke',
'lynas', 'lynge', 'lynne', 'lynns', 'lyzet', 'lænna', 'lærke', 'læsøs', 'løcke', 'løkke',
'lønne', 'mabel', 'macks', 'madja', "mads'", 'magal', 'magda', 'magga', 'maggi', 'magna',
'magne', 'magni', 'magny', 'maias', 'maien', 'maija', 'maika', 'maike', 'maila', 'maina',
'maise', 'maite', 'majas', 'majes', 'majid', 'majka', 'majke', 'majli', 'majsa', 'majse',
'majvi', 'makie', "maks'", 'malia', 'malie', 'malin', 'malis', 'malla', 'malle', 'malmö',
'malmø', 'malou', 'malta', 'malte', 'malue', 'mamie', 'manda', 'mandø', 'manja', 'manly',
'manna', 'manne', 'manno', 'manon', 'maras', 'marck', 'marco', 'marcs', 'maren', 'marga',
'maria', 'marie', 'marin', 'mario', 'maris', 'marit', 'marja', 'marka', 'marko', 'marks',
'marna', 'marne', 'marni', 'marno', 'marry', 'marta', 'marte', 'marti', 'marty', "marx'",
'marya', 'marys', 'masha', 'masja', "mass'", 'matie', 'matis', "mats'", 'matti', 'matts',
'mauds', 'mauri', "max's", 'maxim', 'mayas', 'means', 'mecka', 'mecks', 'medea', 'meeri',
'megan', 'meike', 'meiks', 'meino', 'meirs', 'mejse', 'melie', 'menja', 'menos', 'merab',
'merci', 'mercy', 'meris', 'merle', 'merly', 'merri', 'merry', 'merte', 'merys', 'metas',
'metea', 'metha', 'metia', 'metta', 'mette', 'metty', 'mians', 'micas', 'micha', 'michs',
'micka', 'micki', 'micks', 'micky', 'micos', 'midde', 'mieke', 'mijas', 'mikal', 'mikas',
'mikes', 'mikey', 'mikie', 'mikis', 'mikka', 'mikki', 'mikko', 'mikks', 'milan', 'milas',
'milda', 'milia', 'milka', 'milla', 'mille', 'millo', 'milly', 'milos', 'mimis', 'mimmi',
'minas', 'minea', 'mines', 'mingo', 'minik', 'minis', 'minix', 'minja', 'minka', 'minna',
'minne', 'miras', 'miris', 'mirja', 'mirka', 'mirko', 'mirla', 'mirna', 'miros', 'mirra',
'mirsa', 'mirza', 'misha', 'misja', 'miska', 'mitra', 'mitte', 'mitzi', 'mitzy', 'molay',
'molly', "mols'", 'molte', 'momme', 'monas', 'mones', 'monia', 'monis', 'monja', 'monna',
'monne', 'monty', 'moore', 'moses', 'mossø', 'mouse', 'moust', 'munck', 'munin', 'mylia',
'myrna', 'märta', 'månen', 'mærsk', "nbi's", 'njlug', 'nadia', 'nadja', 'naias', 'naija',
'naila', 'naima', 'najas', 'nanas', 'nancy', 'nanda', 'nanes', 'nanet', 'nanja', 'nanna',
'nanne', 'nanni', 'nanns', 'nanny', 'naomi', 'natan', 'nauja', 'nauru', 'nayas', 'neals',
'nedja', 'neela', 'neels', 'neema', 'neias', 'neija', 'neika', 'neils', 'neksø', 'nelas',
'neles', 'nelie', 'nella', 'nelle', 'nelli', 'nells', 'nelly', "nels'", 'nenes', 'nenna',
'nepal', 'netas', 'netes', 'nethe', 'netta', 'nette', 'netti', 'netty', 'nevil', 'niall',
'nichi', 'nicis', 'nicka', 'nicki', 'nicko', 'nicks', 'nicky', 'nicla', 'nicol', 'nicos',
'niela', 'niels', 'nigel', 'niger', 'nikas', 'nikis', 'nikka', 'nikki', 'nikos', 'nilas',
'nilda', 'nilen', 'niles', 'nilla', 'nille', "nils'", 'nimas', 'ninas', 'ninel', 'nines',
'ninia', 'ninis', 'ninja', 'ninka', 'ninna', 'ninne', 'ninni', 'ninon', 'ninos', "niss'",
'nitas', 'nitta', 'nivan', 'nivis', 'nixon', 'njals', 'noahs', 'noals', 'noels', 'noemi',
'nokia', 'nomis', 'nonas', 'nonie', 'nonni', 'nonny', 'noomi', 'noras', 'nordu', 'nores',
'norge', 'norma', 'novos', 'noëls', 'nukas', 'nuoro', 'nynne', 'nyrup', 'nærum', "nøks'",
'nønne', 'nørre', "ooo's", 'obert', 'odder', 'odger', 'odile', 'odine', 'odins', 'odlev',
'odmar', 'olafs', 'olais', 'olajs', 'olaus', 'olava', 'olavs', 'olbia', 'oleas', 'olegs',
'olens', 'olgas', 'olina', 'oline', 'olise', 'oliva', 'olive', 'ollas', 'olles', 'olofs',
'olovs', 'olsen', 'olufs', 'omans', 'omars', 'oonas', 'orlas', 'osama', 'oscar', 'oskar',
'oslos', 'osman', 'osmar', 'othar', 'otine', 'otmar', 'ottar', 'ottas', 'ottes', 'ottos',
'ovard', 'owens', "pdf's", "phk's", 'posix', 'paavo', 'pablo', 'pacos', 'paick', 'paies',
'palle', 'palls', 'palma', 'pansy', 'paolo', 'paris', 'parly', 'parmo', 'pauel', 'paula',
'pauli', 'paulo', 'pauls', 'pawel', 'pearl', 'peder', 'pedro', 'peers', 'peggy', 'pehrs',
'peiks', 'pejas', 'pejks', 'peles', 'pelle', 'penny', 'penti', 'percy', 'perry', 'perus',
'petas', 'peter', 'petes', 'petra', 'petri', 'petro', 'pfalz', 'pians', 'piets', 'piias',
'piils', 'pilar', 'pinas', 'piotr', 'pipis', 'pippi', "pius'", 'pluto', 'polen', 'polly',
'pouel', 'poula', 'pouli', 'pouls', 'povel', 'povla', 'povls', 'prosa', 'pusle', 'qatar',
'quist', 'qvans', 'racid', 'ragna', 'ragns', 'raimo', 'raini', 'rajas', 'rakel', 'rakis',
'ralff', 'ralfs', 'ralph', 'ramis', 'ramon', 'randa', 'randi', 'randy', 'ranes', 'rania',
'ranja', 'ranva', "rass'", 'rauls', 'rauno', 'ravns', 'regin', 'reier', 'reila', 'reino',
'rejer', 'remis', 'remon', 'remos', 'remus', 'remys', 'renas', 'renee', 'renes', 'renie',
'renis', 'renny', 'renos', 'renée', 'retas', 'retos', "rex's", 'rheas', 'rhina', 'rhoda',
'riber', 'ricco', 'richo', 'ricka', 'ricki', 'ricko', 'ricky', 'ricos', 'riefs', 'rieke',
'riffs', 'rigos', 'rikka', 'rikke', 'rikki', 'rikko', 'rikos', 'rilla', 'rimas', 'rinas',
'rinda', 'rines', 'rinie', 'rinna', 'rinos', 'risas', 'rises', 'risøs', 'ritas', 'ritha',
'riths', 'ritta', 'ritte', 'ritts', 'ritva', 'ritza', 'roald', 'roall', 'roans', 'roark',
'roars', 'robbi', 'robby', 'robin', 'rocco', 'rocko', 'rocky', 'roers', 'roger', 'rokil',
'rolas', 'rolff', 'rolfs', 'rollo', 'roman', 'romas', 'romeo', 'roméo', 'ronas', 'rones',
'ronia', 'ronja', 'ronni', 'ronns', 'ronny', 'rosas', 'rosea', 'roses', 'rotas', 'royni',
'ruars', 'ruben', 'rubis', 'rubys', 'ruddi', 'ruddy', 'rudis', 'rudys', 'rufus', 'rukan',
'rumle', 'runar', 'runas', 'runes', 'runis', 'runna', 'runos', 'rurik', 'rusla', 'ruths',
'ryans', 'ryles', 'ryolf', 'rødby', 'rønde', 'rønne', "sdu's", 'sslug', 'sacha', 'sacho',
'sadia', 'safie', 'sagas', 'sahra', 'sails', 'saima', 'saisa', 'sakse', 'sakso', 'salca',
'salka', 'salli', 'sally', 'salum', 'samia', 'sammi', 'sammy', 'samoa', 'samos', 'samsø',
'sanas', 'sandi', 'sandy', 'sanes', 'sanja', 'sankt', 'sanna', 'sanne', 'sanni', 'sanny',
'sarah', 'saras', 'saris', 'sasas', 'sasia', 'sasja', 'savas', 'saxes', 'saxos', 'scott',
'seans', 'sebbe', 'seier', 'seija', 'seirs', 'sejer', 'sejrs', 'sella', 'selma', 'semmy',
'senia', 'senna', 'senta', 'seppo', 'sepps', 'serge', 'sesil', 'sessa', 'seths', 'shane',
'shaun', 'shawn', 'sheba', 'shila', 'sibyl', 'sidse', 'siena', 'siffs', 'siger', 'sigga',
'sigge', 'siggi', 'signa', 'signe', 'signi', 'signy', 'sigyn', 'sikas', 'silas', 'silja',
'silje', 'silke', 'silla', 'sille', 'silpa', 'silva', 'simen', 'simon', 'sinas', 'sines',
'sinja', 'sinna', 'sinne', 'sinus', 'siras', 'sires', 'siria', 'sirid', 'siris', 'sisan',
'sisie', 'sisis', 'siska', 'sissa', 'sisse', 'sissi', 'sitas', 'sitta', 'sivel', 'skats',
'skive', 'skuli', 'skype', 'skåne', 'smila', 'snæja', 'soffi', 'soffy', 'sofia', 'sofie',
'sofja', 'sofus', 'sonia', 'sonja', 'sonna', 'sonni', 'sonny', 'sophy', 'stans', 'steen',
'steff', 'stege', 'stens', 'steve', 'stigs', 'stiig', 'stina', 'stine', 'stone', 'storå',
'sture', 'sturm', 'sudan', 'sunas', 'sunes', 'sunie', 'sunis', 'sunna', 'sunns', 'sunny',
'susan', 'susia', 'susie', 'susis', 'susse', 'sussi', 'sussy', 'susys', 'suzan', 'suzie',
'suzis', 'suzys', 'svala', 'svava', 'sveas', 'svein', 'svend', 'svenn', 'svens', 'sylva',
'synne', 'syrak', 'sølva', 'sølve', 'sølvi', 'søren', 'tabia', 'tacha', 'tadea', 'tades',
'tagea', 'tages', 'tagos', 'taias', 'taico', 'taija', 'taila', 'taimi', 'taina', "tais'",
'tajas', 'tajco', "tajs'", 'talia', 'talli', 'tamar', 'tamas', 'tamis', 'tamra', 'tanas',
'tania', 'tanja', 'tanna', 'tanne', 'tanni', 'tanos', 'tanya', 'tapio', 'taras', 'tarek',
'tarik', 'tasha', 'tasia', 'tasja', 'tassa', "taus'", 'taves', "tavs'", 'tchad', 'tecla',
'tedas', 'teddi', 'teddy', 'teela', 'teena', 'teias', "teis'", 'teits', 'tejns', "tejs'",
'tekla', 'telma', 'telse', 'temme', 'temmi', 'tenas', 'tenes', 'tenja', 'tenna', 'terja',
'terje', 'terka', 'terna', 'terne', 'terri', 'terry', "tess'", 'tessa', "tex's", "teys'",
'thage', 'thais', 'thala', 'thara', 'thaya', 'theas', 'theis', 'thejs', 'thems', 'theon',
'theos', 'thias', 'thims', 'thina', 'thine', 'thing', 'thios', 'thits', 'thoas', 'thoke',
'thoma', 'thoms', 'thony', 'thora', 'thord', 'thore', 'thors', 'thues', 'thule', 'thune',
'thure', 'thuri', 'thyge', 'thyra', 'thyre', 'thøge', 'tiana', 'tiane', "tias'", 'tibet',
'tibor', 'ticho', 'tidas', 'tiina', 'tikas', 'tilas', 'tilda', 'tilde', 'tilka', 'tilla',
'tille', 'tills', 'tilos', 'tilse', 'tilst', 'times', 'timia', 'timme', 'timmi', 'timmo',
'timms', 'timmy', 'timos', 'tinas', 'tinea', 'tines', 'tinie', 'tinja', 'tinna', 'tinne',
'tinny', 'tinos', 'tinus', 'tiras', 'tirsa', 'tirza', 'tises', 'tissø', 'titos', 'titta',
'titte', 'titti', 'tjana', 'tjørk', 'tjørn', 'tobby', 'tobys', 'togis', 'toivo', 'tokes',
'tokis', 'tolas', 'tolva', 'tomas', 'tommi', 'tomms', 'tommy', 'tonas', 'tones', 'tonga',
'tonie', 'tonja', 'tonje', 'tonni', 'tonny', 'tonya', 'tonys', 'toras', 'tords', 'tores',
'torid', 'toril', 'torin', 'torke', 'torms', 'torny', 'torre', 'torry', 'torun', 'toste',
'tovas', 'toves', 'trein', 'trina', 'trine', 'trohn', 'trond', 'trude', 'trudi', 'truls',
'tryms', 'tsuno', 'tucos', 'tudis', 'tulas', 'tulla', 'tumes', 'tunas', 'tunes', 'tures',
'turfs', 'turid', 'turis', 'tutta', 'tutte', 'tutts', 'tuula', 'tycho', 'tyges', 'tyras',
'tyres', 'tyrol', 'tytte', 'tøger', 'tørks', 'ubbes', 'uffes', 'uffos', 'ulffs', 'uljas',
'ullas', 'ulric', 'ulrik', 'ulver', 'unnas', 'unnes', 'unnie', 'unnis', 'urban', 'vaage',
'vagna', 'vagns', 'vaike', 'vaino', 'valby', 'valdo', 'valli', 'vally', 'vanda', 'vandy',
'vanja', 'varde', 'varla', 'varna', 'varny', 'vavas', 'vegas', 'veijo', 'vejdi', 'vejen',
'vejle', 'velas', 'venca', 'venia', 'venis', 'venke', 'venus', 'veras', 'verna', 'vesla',
'vesta', 'vesti', 'vesty', 'viana', 'viben', 'vibes', "vibs'", 'vibse', 'vibæk', 'vicas',
'vicha', 'vicki', 'vicky', 'vidar', 'vifil', 'vigan', 'vigga', 'vigge', 'viggo', 'vigil',
'vikas', 'vikie', 'vikis', 'vikka', 'vikki', 'vilda', 'vilia', 'vilja', 'villi', 'villy',
'vilma', 'vilna', 'vilni', 'vinas', 'vinca', 'vinie', 'vinis', 'vinja', 'vinka', 'vinna',
'vinni', 'viola', 'viols', 'viras', 'virum', 'viste', 'visti', 'vitas', 'vitha', 'vitos',
'vitta', 'vitus', 'vivan', 'vivas', 'vivia', 'vivie', 'vivis', 'vonge', 'våges', "who's",
'waage', 'wagna', 'wagns', 'wahid', 'walid', 'walli', 'wally', 'wanda', 'wandy', 'wange',
'wanja', 'warla', 'warna', 'warny', 'weena', 'weiss', 'welas', 'wendy', 'weras', 'werna',
'wicki', 'wicky', 'wiens', 'wigan', 'wigga', 'wiggo', 'wikis', 'wilda', 'wilja', 'willi',
'willy', 'wilma', 'winas', 'winie', 'winis', 'winna', 'winni', 'winns', 'wisti', 'witas',
'witha', 'witta', 'witte', 'wivan', 'wivis', 'wiwis', 'wotan', 'wyrna', 'wåges', 'xenia',
'y-tog', 'yades', 'yaels', 'yanns', 'yding', 'yduns', 'yelva', 'yemen', 'ylvas', 'yngva',
'yngve', 'yomas', 'yonna', 'yrsas', 'ystad', 'yttas', 'yttes', 'yuris', 'yvans', "yves'",
'yvonn', 'yvons', 'zahra', 'zaire', 'zakia', 'zakis', 'zanas', 'zanna', 'zanne', 'zanno',
'zanny', 'zapps', 'zarah', 'zaras', 'zazas', 'zazia', 'zeans', 'zella', 'zelma', 'zemas',
'zenia', 'zenja', 'zenta', 'zessa', 'zeths', 'ziads', 'zidas', 'ziers', 'zigas', 'zilas',
'zilla', 'zimon', 'zinas', 'zindy', 'ziras', 'ziska', 'zitas', 'zitha', 'zitta', 'zofia',
'zofie', 'zofja', 'zoran', 'zosia', 'zuzan', "a'ers", "a'ets", 'abbed', "abc's", 'abede',
'abens', 'abers', 'abort', 'acces', 'adder', 'addér', 'adels', 'adept', 'adler', 'adles',
'adlet', 'adlyd', 'adlød', 'adræt', 'advar', 'advis', 'aedes', 'aende', 'aerob', 'afart',
'afasi', 'afbag', 'afben', 'afbud', 'afbær', 'afbød', 'afdæk', 'afdød', 'affat', 'affej',
'affil', 'affyr', 'affød', 'affør', 'afgas', 'afgav', 'afgik', 'afgiv', 'afgud', 'afgår',
'afgær', 'afgør', 'afhop', 'afhud', 'afhug', 'afhår', 'afhør', 'afise', 'afkod', 'afkog',
'afkom', 'afkøl', 'aflad', 'afled', 'aflir', 'afliv', 'aflok', 'afluk', 'aflur', 'aflus',
'aflyd', 'aflys', 'aflyt', 'aflås', 'aflæg', 'aflæs', 'afløb', 'afløn', 'afløs', 'afløv',
'afmal', 'afmat', 'afmej', 'afmål', 'afnød', 'afpas', 'afpil', 'afpæl', 'afret', 'afrev',
'afrig', 'afrim', 'afriv', 'afryd', 'afsat', 'afsav', 'afser', 'afses', 'afset', 'afsig',
'afsky', 'afslå', 'afson', 'afstå', 'afsyr', 'afsæb', 'afsæt', 'aftag', 'aftal', 'aften',
'aftes', 'aftne', 'aftog', 'afveg', 'afvej', 'afvig', 'afvis', 'afvæn', 'afæsk', 'agape',
'agars', 'agats', 'agave', 'agede', 'agens', 'agent', 'agere', 'agern', 'agers', 'agnat',
'agnen', 'agnet', 'agoni', 'agora', 'agraf', 'agrar', 'agres', 'agten', 'agter', 'agtes',
'agtet', 'agurk', 'ahorn', 'ajlen', 'ajour', 'akryl', 'aksel', 'aksen', 'akser', 'akses',
'akset', 'aksle', 'akten', 'akter', 'aktie', 'aktiv', 'aktor', 'aktør', 'alarm', 'albue',
'album', 'alder', 'aldre', 'alene', 'alens', 'alert', 'alfen', 'alfer', 'algen', 'alger',
'alges', 'algod', 'algol', 'alhus', 'alias', 'alibi', 'alkyd', 'alles', 'allés', 'almen',
'almue', 'aloen', 'aloer', 'aloes', 'alpen', 'alper', 'alpin', 'alrum', 'altan', 'alter',
'altet', 'altid', 'altre', 'altså', 'alvor', 'ambra', 'ammen', 'ammer', 'ammes', 'ammet',
'amorf', 'amour', 'ampel', 'ampul', 'amter', 'amtet', 'amøbe', 'anale', 'analt', 'andel',
'anden', 'andet', 'andre', 'anede', 'anfør', 'angav', 'anger', 'angik', 'angiv', 'angle',
'angre', 'angst', 'angår', 'anion', "anis'", 'anjon', 'ankel', 'anken', 'anker', 'ankes',
'anket', 'ankom', 'ankre', 'anlæg', 'anløb', 'anmod', 'annal', 'annua', 'anode', 'anret',
'anråb', 'ansat', 'anser', 'anses', 'anset', 'ansku', 'anslå', 'anstå', 'ansås', 'ansæt',
'ansøg', 'antag', 'antal', 'antik', 'antog', 'antyd', 'anvis', 'anæmi', 'aorta', 'apati',
'apeks', 'appel', 'april', 'apsis', 'apter', 'aptér', 'araen', 'araer', 'areal', 'arena',
'arene', 'arens', 'argon', 'argot', 'arien', 'arier', 'aries', 'arisk', 'arken', 'arker',
'arket', 'arkiv', 'armen', 'armer', 'armes', 'armod', 'armér', 'armés', 'arnen', 'arner',
'arnes', 'aroma', 'arpet', 'arrak', 'arret', 'arrig', 'arsen', 'arses', 'arsis', 'arten',
'arter', 'artes', 'artet', 'artig', 'arven', 'arver', 'arves', 'arvet', 'arvæv', 'asede',
'asens', 'asers', 'asiat', 'asien', 'asier', 'asies', 'asiet', 'asken', 'asker', 'asket',
'asner', 'asnet', 'aspen', 'aspes', 'aspic', 'asser', 'asset', 'astma', 'asyls', 'atlas',
'atlet', 'atols', 'atoms', 'atoni', 'attak', 'atten', 'atter', 'attrå', 'audit', 'augur',
'aulas', 'auras', 'autor', 'autos', 'avecs', 'avers', 'avind', "avis'", 'avlen', 'avler',
'avles', 'avlet', 'avnen', 'avner', 'avnes', 'avnet', 'azurs', "b'ers", "b'ets", 'babys',
'bacon', 'bader', 'bades', 'badet', 'badge', 'badut', 'bagen', 'bager', 'bages', 'bagom',
'bagpå', 'bagte', 'bagud', 'bajer', 'bajet', 'bakke', 'bakse', 'balde', 'balge', 'balgs',
'balje', 'balle', 'bamle', 'bamse', 'banal', 'banan', 'bande', 'bands', 'bandt', 'banen',
'baner', 'banes', 'banet', 'bange', 'banjo', 'banke', 'banko', 'banks', 'bantu', 'barak',
'barbe', 'barde', 'baren', 'barer', 'bares', 'baret', 'barke', 'barks', 'barme', 'barms',
'barns', 'barok', 'baron', 'barre', 'barsk', 'barsl', 'baryl', 'baryt', 'basal', 'basar',
'basen', 'baser', 'bases', 'basic', 'basis', 'baske', 'basse', 'basta', 'baste', 'basts',
'basun', 'batat', 'batch', 'batik', 'batte', 'batts', 'bavls', 'bavne', 'bavns', 'bebop',
'bebor', 'bebos', 'bebud', 'bebyg', 'beden', 'beder', 'bedes', 'bedet', 'bedre', 'bedst',
'bedyr', 'bedår', 'bedæk', 'bedøm', 'bedøv', 'befal', 'befar', 'befor', 'befri', 'beføj',
'beføl', 'begav', 'beges', 'beget', 'begge', 'begik', 'begiv', 'beglo', 'begår', 'begås',
'begær', 'behag', 'behov', 'beige', 'bejae', 'bejds', 'bejle', 'bekom', 'belav', 'belur',
'belys', 'belån', 'belæg', 'belær', 'belæs', 'beløb', 'beløj', 'beløn', 'bemal', 'bemøj',
'bener', 'benet', 'benyt', 'benåd', 'beoen', 'beoer', 'bered', 'beret', 'berig', 'beror',
'berus', 'beryl', 'beråd', 'berøm', 'berør', 'berøv', 'besad', 'besat', 'beser', 'beses',
'beset', 'besid', 'beske', 'beskt', 'besku', 'beslå', 'besov', 'bestå', 'besyv', 'besæt',
'besøg', 'betag', 'betak', 'betal', 'betas', 'betel', 'beten', 'beter', 'betle', 'betog',
'beton', 'betro', 'betød', 'bevar', 'bevis', 'bevæg', 'beære', "bh'en", "bh'er", 'biavl',
'bibel', 'bider', 'bides', 'bidet', 'bidsk', 'bidte', 'biens', 'biers', 'bifag', 'bifil',
'bigot', 'bijob', 'bikse', 'bilag', 'bilde', 'bildt', 'biled', 'bilen', 'biler', 'biles',
'bilet', 'bilkø', 'bille', 'bilos', 'bilyd', 'bimle', 'bimse', 'binde', 'binds', 'bingo',
'binær', 'bioen', 'bioer', 'biord', 'bippe', 'birke', 'birks', 'birum', 'bisag', 'bisam',
'bisat', 'bisen', 'biser', 'bises', 'bisol', 'bison', 'bisps', 'bisse', 'bistå', 'bitre',
'bitte', 'bivej', 'bivån', 'bizar', 'bjerg', 'bjesk', 'bjæfs', 'bjærg', 'bjørn', 'blade',
'bladr', 'blads', 'blafr', 'bland', 'blank', 'blase', 'bleen', 'bleer', 'blege', 'blegn',
'blegt', 'blend', 'blide', 'blidt', 'bliks', 'blind', 'blink', "blis'", 'blist', 'blitz',
'blive', 'blods', 'bloks', 'blond', 'blote', 'blots', 'blues', 'bluff', 'blund', "blus'",
'bluse', 'blyet', 'blåne', 'blårs', 'blæks', 'blænd', 'blære', 'blærs', 'blæse', 'blæst',
'blævr', 'bløde', 'blødt', 'boaen', 'boaer', 'bobbe', 'boble', 'bodel', 'boden', 'boder',
'bodil', 'boede', 'boens', 'boere', 'boers', 'boets', 'bogen', 'bogie', 'bojan', 'bojar',
"boks'", 'bokse', 'bolde', 'bolds', 'boler', 'boles', 'bolet', 'bolig', 'bolle', 'bolte',
'bolts', 'bombe', 'bomme', 'bonde', 'bonen', 'boner', 'bones', 'bonet', 'bonus', 'booke',
'booms', 'boote', 'bopæl', 'borde', 'bords', 'borer', 'bores', 'boret', 'borge', 'borgs',
'borst', 'borte', 'bosat', "boss'", 'bosse', 'boven', 'boves', 'bovne', 'bowle', 'boxer',
'brage', 'brags', 'bragt', 'brand', 'brank', 'brase', 'brask', 'brast', 'brave', 'bravo',
'bravt', 'break', 'brede', 'bredt', 'brems', 'breve', 'brevs', 'brief', 'brien', 'brier',
'bries', 'briks', 'bring', 'brink', 'brint', 'brise', 'brist', 'brite', 'broen', 'broer',
'brors', 'brovt', 'brude', 'bruds', 'brudt', 'bruge', 'brugs', 'brugt', 'brune', 'brunt',
"brus'", 'bruse', 'brusk', 'bryde', 'brygs', 'bryns', 'brysk', 'bryst', 'brædt', 'bræen',
'bræer', 'bræge', 'bræks', 'brænd', 'bræts', 'brøde', 'brøds', 'brøks', 'brøle', 'brøls',
'brønd', 'brøst', 'budes', 'buede', 'buens', 'buers', 'bugen', 'buggy', 'bugne', 'bugte',
'bugts', 'buhko', 'buket', 'bukke', 'bukle', 'buldr', 'bulen', 'buler', 'bules', 'bulet',
'bulke', 'bulks', 'bulle', 'bulme', 'bulne', 'bumle', 'bumpe', 'bumps', "bums'", 'bumse',
'bunde', 'bunds', 'bundt', 'bunke', 'burde', 'burer', 'bures', 'buret', 'burre', 'buser',
'buses', 'buset', 'buske', 'busks', 'buste', 'butan', 'butik', 'bybos', 'bybud', 'bybus',
'bydel', 'byder', 'bydes', 'byens', 'byers', 'bygas', 'bygds', 'bygen', 'byger', 'byges',
'byget', 'bygge', 'byhus', 'bylds', 'byliv', 'bylts', 'bymur', 'bynke', 'bynær', 'byrde',
'byret', 'byrum', 'byråd', 'byste', 'bytes', 'bytte', 'bytur', "bz'er", 'båden', 'bådes',
'båken', 'båker', 'båkes', 'bålet', 'bånde', 'bånds', 'båren', 'bårer', 'båres', 'båret',
'bårne', 'båsen', 'båses', 'bæens', 'bæers', 'bæets', 'bæger', 'bægre', 'bække', 'bælge',
'bælgs', 'bælle', 'bælte', 'bælts', 'bænke', 'bænks', 'bærer', 'bæres', 'bærme', 'bæsts',
'bæven', 'bæver', 'bævet', 'bævre', 'bøden', 'bøder', 'bødes', 'bødet', 'bødle', 'bøffe',
'bøgen', 'bøger', 'bøges', 'bøget', 'bøjen', 'bøjer', 'bøjes', 'bøjet', 'bøjle', 'bølge',
'bølle', 'bønne', 'børen', 'børes', 'børns', 'børst', 'bøsse', 'bøtte', 'bøvet', 'bøvse',
"c'ers", "c'ets", 'cafes', 'cafés', 'capen', 'caper', 'capes', "cd'en", "cd'er", 'cdrom',
'ceder', 'cedre', 'celle', 'cello', 'cerut', 'charm', 'check', 'chefs', 'chili', 'chips',
'cider', 'cifre', 'cigar', 'cirka', 'citar', 'citat', 'citer', 'civil', 'clear', 'clips',
'coate', 'colas', 'conga', 'coupe', 'coupé', 'cover', 'crack', 'crawl', 'crazy', 'credo',
'creme', 'crepe', 'curie', 'cutte', 'cykel', 'cykle', 'cyste', 'cæsar', 'cæsur', "d'ers",
"d'ets", 'dadel', 'dadle', 'dagen', 'dages', 'dalbo', 'dalen', 'daler', 'dales', 'dalet',
'dalre', 'damen', 'damer', 'dames', 'damet', 'damme', 'dampe', 'damps', 'danbo', 'dandy',
'daner', 'danne', "dans'", 'danse', 'dansk', 'daser', 'daset', 'daske', 'datas', 'dater',
'datid', 'dativ', 'datos', 'david', 'davre', 'debat', 'debet', 'debil', 'debug', 'debut',
'decca', 'decim', 'decks', 'deger', 'degne', 'degns', 'deist', 'dejen', 'dejes', 'dejet',
'dejse', 'dekan', 'dekor', 'delen', 'deler', 'deles', 'delle', 'delta', 'delte', 'denar',
'denim', 'denne', 'dente', 'depot', 'deraf', 'derby', 'deres', 'derom', 'derop', 'derpå',
'derud', 'desto', 'dette', 'devon', 'devot', 'diaer', 'diaet', 'diare', 'diaré', 'dible',
'digel', 'diger', 'diges', 'diget', 'digre', 'digte', 'digts', 'dikke', 'dildo', 'dilds',
'dille', 'dinar', 'diner', 'dingo', 'diode', 'dipol', 'dirke', 'dirks', 'dirre', 'disen',
'diset', 'diske', 'disko', 'disks', 'disse', 'ditto', 'divan', 'divas', 'diæts', 'djærv',
'doble', 'docer', 'dogen', 'doger', 'doges', 'dogme', 'dokke', 'dolce', 'dolke', 'dolks',
'dolme', 'domme', 'donen', 'doner', 'dones', 'donna', 'donor', 'doper', 'dopet', 'dorer',
'dorge', 'dorgs', 'dorne', 'dorsk', 'dosen', 'doser', 'dosis', 'doter', 'douce', 'doven',
'dovne', 'doyen', 'dozer', 'drabs', 'drage', 'drags', 'dragt', 'dragé', 'drama', 'drapa',
'dreje', 'drejl', 'drejs', 'dreng', 'dress', 'drevs', 'dribl', 'drift', 'drink', 'drist',
'drive', 'droge', 'drogs', 'drone', 'drops', 'drost', 'drude', 'druen', 'druer', 'drues',
'drukn', "drys'", 'dråbe', 'dræbe', 'dræbt', 'drægs', 'dræne', 'dræns', 'dræve', 'drøft',
'drøje', 'drøjt', 'drøms', 'drømt', 'drøne', 'drøns', 'dubbe', 'duble', 'dublé', 'duede',
'duels', 'duens', 'duers', 'duets', 'dufte', 'dufts', 'dugen', 'duges', 'dugge', 'dugts',
'dukat', 'dukke', 'dulgt', 'dulle', 'dulme', 'dumme', 'dummy', 'dumpe', 'dumps', 'dumpt',
'duner', 'dunes', 'dunet', 'dunke', 'dunks', 'dunst', 'dunte', 'duoen', 'duoer', 'duper',
'duplo', 'duppe', 'duren', 'dusin', 'duske', 'dusks', 'dusør', 'dutte', 'dvale', 'dvask',
"dvd's", 'dvæle', 'dværg', 'dybde', 'dybel', 'dybet', 'dybsø', 'dyden', 'dyder', 'dydig',
'dykke', 'dynen', 'dyner', 'dynes', 'dynge', 'dyppe', 'dyres', 'dyret', 'dyrke', 'dysen',
'dyser', 'dyses', 'dysse', 'dyste', 'dysts', 'dytte', 'dyvel', 'dåben', 'dåden', 'dådyr',
'dåens', 'dåers', 'dålam', 'dåner', 'dånet', 'dåren', 'dårer', 'dåres', 'dåret', 'dåsen',
'dåser', 'dåses', 'dægge', 'dække', 'dælen', 'dæmme', 'dæmon', 'dæmpe', 'dæmre', 'dænge',
'døber', 'døbes', 'døbte', 'døden', 'dødis', 'døgns', 'døjer', 'døjet', 'dølge', 'dølle',
'dømme', 'dømte', 'dønne', 'døren', 'døres', 'dørke', 'dørks', 'døser', 'døset', 'døsig',
'døtre', 'døver', 'døves', 'døvet', "e'ers", "e'ets", 'ebben', 'ebber', 'ebbes', 'eclat',
"edb's", 'eddas', 'edder', 'edens', 'eders', 'edikt', 'efeus', 'effen', 'efors', 'efter',
'egalt', 'egene', 'egens', 'egern', 'egers', 'egnen', 'egner', 'egnes', 'egnet', 'egoer',
'egoet', 'ejede', 'ejere', 'ejers', 'ekkos', 'eksem', 'ekser', 'ekses', 'ekset', 'eksil',
'elbil', 'elegi', 'elevs', 'elgen', 'elges', 'elgko', 'elite', 'eller', 'elles', 'elmen',
'elmes', 'elske', 'elven', 'elver', 'elves', 'elvte', 'emacs', 'emden', 'emder', 'emdes',
'emirs', 'emmer', 'emmet', 'emner', 'emnes', 'emnet', 'emsig', 'emuen', 'emuer', 'endda',
'enden', 'ender', 'endes', 'endnu', 'endog', 'endte', 'enere', 'eners', 'engel', 'engen',
'enges', 'engle', 'enhed', 'enige', 'enigt', 'enkel', 'enken', 'enker', 'enkes', 'enkle',
'enlig', 'enorm', 'enrum', 'ensom', 'ental', 'enten', 'entre', 'entré', 'enzym', 'enøre',
'eolit', 'episk', 'epoke', 'epope', 'epopé', 'epoxy', 'erfar', 'erika', 'erlæg', 'erobr',
"eros'", 'erots', 'espen', 'espes', 'esrom', 'essay', 'essen', 'esser', 'esses', 'esset',
'essig', 'ester', 'etaer', 'etaet', 'etage', 'etape', 'etats', 'etbær', 'etiks', 'etisk',
'etmål', 'ettal', 'etter', 'etude', 'etuis', 'etårs', 'eunuk', 'event', 'evert', 'evige',
'evigt', 'evnen', 'evner', 'evnes', 'evnet', 'exces', 'exede', "f'ers", "f'ets", 'fabel',
'fable', 'facet', 'facil', 'facit', 'facon', 'facto', 'facts', 'fader', 'fades', 'fadet',
'fadøl', 'fager', 'faget', 'fagot', 'fagre', 'fakir', 'fakta', 'falde', 'falds', 'faldt',
'falke', 'falks', 'falle', 'falme', 'false', 'falsk', 'famle', 'famøs', 'fandt', 'fanen',
'faner', 'fanes', 'fange', 'farad', 'farao', 'farce', 'faren', 'farer', 'fares', 'faret',
'farin', 'farme', 'farms', 'farne', "fars'", 'farsi', 'farte', 'farts', 'farve', 'fasan',
'fasen', 'faser', 'fases', 'faste', 'fatal', 'fatte', 'fauna', 'fauns', 'favne', 'favns',
'favør', 'faxen', 'faxer', 'feber', 'febre', 'feder', 'fedet', 'fedme', 'fedte', 'fedts',
'feens', 'feers', 'fehår', 'fejde', 'fejer', 'fejet', 'fejle', 'fejls', 'fejre', 'felts',
'femte', 'femti', 'femår', 'fenne', 'fenol', 'fenyl', 'ferie', 'ferle', 'ferme', 'fermt',
'fersk', 'feset', 'feste', 'fests', 'fetas', 'feter', 'fiber', 'fibre', 'fichu', 'ficus',
'fidel', 'fidus', 'fiffe', 'fifle', 'figen', 'fight', 'figur', 'fikse', 'fikst', 'filen',
'filer', 'files', 'filet', 'filme', 'films', 'filte', 'filts', 'filur', 'fimet', 'fimre',
"fims'", 'fimse', 'final', 'finde', 'finer', 'fingr', 'finit', 'finke', 'finne', 'finsk',
'finte', 'fiols', 'firer', 'fires', 'firet', 'firma', 'firme', 'firti', 'fiser', 'fiset',
'fiske', 'fisks', 'fisse', 'fiste', 'fistr', 'fixet', 'fjant', "fjas'", 'fjase', 'fjeld',
'fjern', 'fjers', 'fjert', 'fjogs', 'fjols', 'fjong', 'fjord', 'fjumr', 'fjums', 'fjæle',
'fjæls', 'fjært', "fjæs'", 'flabe', 'flabs', 'flade', 'fladt', 'flage', 'flagr', 'flags',
'flair', 'flaks', 'flakt', 'flane', 'flapr', 'flash', 'flere', 'flest', 'flids', 'flige',
'fligs', 'flink', 'flint', 'flire', 'flirt', 'flise', 'flods', 'floks', 'flora', 'flors',
'flove', 'flovt', 'flows', 'fluat', 'fluen', 'fluer', 'flues', 'flugt', 'fluid', 'fluks',
'fluor', 'flute', 'flyde', 'flydt', 'flyer', 'flyes', 'flyet', 'flygt', 'flyve', 'flåde',
'flåds', 'flået', 'flåts', 'flæbe', 'flæng', 'flæns', 'flæse', 'flæsk', 'fløde', 'fløje',
'fløjl', 'fløjs', 'fløjt', "fløs'", 'fløse', "fnis'", 'fnise', "fnys'", 'fnyse', 'fobis',
'foden', 'foder', 'fodre', 'foged', 'foget', 'fokus', 'folde', 'folds', 'folen', 'foler',
'foles', 'folet', 'folie', 'folio', 'folks', 'fonde', 'fonds', 'fonem', 'fonte', 'foran',
'forbi', 'force', 'fordi', 'fordr', 'forel', 'foren', 'forer', 'foret', 'forgå', 'forke',
'forks', 'forku', 'forme', 'forms', 'formå', 'forne', 'forny', 'forpå', 'forrå', 'forse',
'forsk', 'forså', 'forte', 'forti', 'forts', 'forud', 'forum', 'foråd', 'forår', 'forær',
'forøg', 'fosse', 'foton', 'fotos', 'foyer', 'fragt', 'fragå', 'franc', 'frank', 'frase',
'frede', 'freds', 'frels', 'freon', 'frier', 'fries', 'friet', 'frise', 'frisk', 'frist',
'fromt', 'front', 'frost', 'fruen', 'fruer', 'frues', 'frugt', 'fryde', 'frygt', 'fryns',
'fryse', 'fråde', 'fråds', 'frækt', 'fræse', 'frøen', 'frøer', 'frøet', 'fugen', 'fuger',
'fuges', 'fuget', 'fugle', 'fugls', 'fugte', 'fugts', "fuks'", 'fulde', 'fulds', 'fuldt',
'fulgt', 'fumle', 'funds', 'funke', 'fuppe', 'furen', 'furer', 'fures', 'furet', 'furie',
'fusel', 'fusen', 'fuser', 'fuses', 'fuset', 'fuske', 'futil', 'futte', 'fyger', 'fyget',
'fylde', 'fyldt', 'fylke', 'fynbo', 'fynsk', 'fyren', 'fyrer', 'fyres', 'fyret', 'fyrig',
'fyrre', 'fyrst', 'fyråb', 'fysik', 'fytin', 'fåret', 'fåtal', 'fæces', 'fædre', 'fæene',
'fæets', 'fægte', 'fæhår', 'fæisk', 'fækal', 'fælde', 'fæles', 'fælge', 'fælgs', 'fælle',
'fænge', 'færde', 'færds', 'færge', 'færre', 'fæste', 'fæstn', 'fætre', 'føden', 'føder',
'fødes', 'fødte', 'føget', 'føjer', 'føjes', 'føjet', 'føjte', 'føler', 'føles', 'følge',
'følte', 'fønen', 'føner', 'fører', 'føres', 'føret', 'først', 'førte', "g'ers", "g'ets",
'gaben', 'gaber', 'gabes', 'gabet', 'gabte', 'gaden', 'gader', 'gades', 'gafle', 'gagat',
'gagen', 'gager', 'gages', 'gaget', "gags'", 'galan', 'galar', 'galde', 'galej', 'galer',
'gales', 'galet', 'galge', 'galla', 'galle', 'galon', 'galop', 'galpe', 'galte', 'galts',
'gambe', 'gamet', 'gamin', 'gamle', 'gamma', 'ganen', 'ganer', 'ganes', 'gange', 'gangs',
'garde', 'garns', 'garve', 'gasen', 'gaser', 'gases', 'gasse', 'gasts', 'gauge', 'gaven',
'gaver', 'gaves', 'gavle', 'gavls', 'gavne', 'gavns', 'gazen', 'gazer', 'gazes', 'geare',
'gears', 'gebet', 'gebis', 'gebyr', 'gedde', 'geden', 'geder', 'gehør', 'gejle', 'gejls',
'gejst', 'gekko', 'geled', 'geles', 'gelés', 'gemak', 'gemal', 'gemen', 'gemme', 'gemse',
'gemte', 'gemyt', 'genbo', 'genen', 'gener', 'genet', 'genis', 'genne', 'genom', 'genre',
'gense', 'genså', 'genua', 'genus', 'gerer', 'gerne', 'gevir', 'gevær', 'gibbe', 'gider',
'gidet', 'gifte', 'gifts', 'gigue', 'gilde', 'gimpe', 'ginen', 'giner', 'gines', 'gipse',
'giraf', 'gisne', 'gispe', 'gisps', 'gitov', 'gitre', 'given', 'giver', 'gives', 'givet',
'givne', 'gjald', 'gjord', 'gjort', 'glade', 'glane', 'glans', 'glemt', 'glibe', 'glide',
'glime', 'glimt', 'glins', 'glitr', 'globe', 'gloet', 'glose', 'glugs', 'glæde', 'gløde',
'gløds', 'gløgg', 'gnask', 'gnave', 'gnejs', 'gnide', 'gnier', 'gnist', 'gnome', 'gnoms',
'gnuen', 'gnuer', 'goden', 'goder', 'godes', 'godet', 'godte', 'gokke', 'golde', 'goldt',
'golfs', 'gople', 'goter', 'gotik', 'gouda', 'grade', 'grads', 'grafs', 'grams', 'grand',
'grans', 'grant', 'grave', 'gravs', 'grebs', 'green', 'greje', 'grejs', 'grelt', 'grene',
'grens', 'greve', 'gribe', 'grifl', 'grill', 'grime', 'grimt', 'grind', 'grine', 'grins',
'grise', 'grisk', 'groet', 'groft', 'grove', 'grube', 'grubl', 'gruer', 'gruet', 'grums',
'grumt', 'grund', 'gruse', 'gryde', 'gryns', 'grynt', 'gråne', 'græde', 'grædt', "græs'",
'græsk', 'grøde', 'grøds', 'grøft', 'grønt', 'guano', 'guava', 'gubbe', 'guden', 'guder',
'guffe', 'gufle', 'guide', 'gulds', 'gules', 'gulne', 'gulve', 'gulvs', 'gumle', 'gumme',
'gummi', 'gumpe', 'gumps', 'gungr', 'gunst', 'guppy', 'gurgl', 'gurus', 'gyden', 'gyder',
'gydes', 'gylle', 'gylpe', 'gylps', 'gylts', 'gynge', 'gyser', 'gyset', 'gyste', 'gytje',
'gyvel', 'gåben', 'gåden', 'gåder', 'gådes', 'gålæg', 'gårde', 'gårds', 'gåsen', 'gåset',
'gåtid', 'gåtur', 'gække', 'gælde', 'gælds', 'gæler', 'gælle', 'gænge', 'gængs', 'gærde',
'gæren', 'gærer', 'gæres', 'gæret', 'gæste', 'gæsts', 'gætte', 'gøder', 'gødet', 'gødsk',
'gøede', 'gøgen', 'gøges', 'gøgle', 'gøgls', 'gøren', 'gøres', "h'ers", "h'ets", 'habil',
'habit', 'hacke', 'hader', 'hades', 'hadet', 'hadsk', 'hagen', 'hager', 'hages', 'haget',
'hagle', 'haiku', 'hajen', 'hajer', 'hakke', 'halen', 'haler', 'hales', 'halet', 'hallo',
'halls', 'halma', 'halon', 'halse', 'halte', 'halve', 'halvt', 'halvø', 'hamit', 'hamle',
'hamme', 'hamre', 'handl', 'handy', 'hanen', 'haner', 'hanes', 'hanke', 'hanks', 'hapse',
'hapss', 'harem', 'haren', 'harer', 'hares', 'harke', 'harme', 'harpe', 'harpy', 'harsk',
'harve', 'hasen', 'haser', 'hases', 'haspe', 'haste', 'hatte', 'hausa', 'havde', 'haven',
'haver', 'haves', 'havet', 'havne', 'havns', 'havre', 'havål', 'heade', 'heats', 'heavy',
'hedde', 'heden', 'heder', 'hedes', 'hefte', 'hegle', 'hegne', 'hegns', 'heile', 'hejre',
'hejsa', 'hejse', 'hejst', 'hekse', 'heler', 'helet', 'helle', 'helme', 'helse', 'helst',
'helte', 'helts', 'helår', 'hemse', 'henad', 'hende', 'hendø', 'hengå', 'henlå', 'henna',
'henne', 'henry', 'hense', 'hente', 'heppe', 'heraf', 'herme', 'herom', 'herop', 'heros',
'herpå', 'herre', 'herse', 'hersk', 'herte', 'hertz', 'herud', 'herut', 'heste', 'hests',
"hetz'", 'hetze', 'hevet', "hf'er", 'hi-fi', 'hidse', 'hiers', 'hiets', 'higen', 'higer',
'higet', 'hikke', 'hikst', 'hilde', 'hille', 'hilse', 'hilst', 'himle', 'hinde', 'hindi',
'hindr', 'hinds', 'hindu', 'hinke', 'hippe', 'hirse', 'hisse', 'hitte', 'hiver', 'hives',
'hivet', 'hjald', 'hjalp', 'hjelm', 'hjord', 'hjort', 'hjuls', 'hjælp', 'hobby', 'hoben',
'hober', 'hobes', 'hobet', 'hofte', 'holde', 'holds', 'holdt', 'holme', 'holms', 'hopla',
'hoppe', 'hopsa', 'horde', 'horer', 'horet', 'horns', 'horst', 'hosen', 'hoser', 'hoses',
'hoste', 'hosts', 'hotel', 'hotte', 'house', 'hoved', 'hoven', 'hover', 'hoves', 'hovne',
'hovsa', 'huden', 'huder', 'hudre', 'huens', 'huers', 'hugaf', 'hugge', 'hugst', 'hujer',
'hujet', 'hulen', 'huler', 'hules', 'hulet', 'hulke', 'hulks', 'hulle', 'human', 'humle',
'humme', 'humor', 'humpe', 'humus', 'humør', 'hunde', 'hunds', 'hungr', 'hurra', 'husar',
'huser', 'huses', 'huset', 'huske', 'husly', 'hutle', 'hutre', 'hvalp', 'hvals', 'hvede',
'hvene', 'hveps', 'hvert', 'hverv', 'hvide', 'hvidt', 'hvile', 'hvils', 'hvine', 'hvins',
'hvisk', 'hvori', 'hvælv', "hvæs'", 'hvæse', 'hybel', 'hyben', 'hydra', 'hygge', 'hykle',
'hylde', 'hylds', 'hylen', 'hyler', 'hyles', 'hylet', 'hylle', 'hymen', 'hymne', 'hynde',
'hyppe', 'hyrde', 'hyren', 'hyrer', 'hyres', 'hyret', 'hysse', 'hytte', 'hyæne', 'håber',
'håbet', 'hånde', 'hånds', 'hånen', 'håner', 'hånes', 'hånet', 'hånle', 'hånsk', 'hårde',
'hårdt', 'håret', 'hæder', 'hædre', 'hæfte', 'hægen', 'hæger', 'hæges', 'hæget', 'hægge',
'hægte', 'hække', 'hækle', 'hælde', 'hældt', 'hælen', 'hæler', 'hæles', 'hælvt', 'hæmme',
'hænde', 'hændt', 'hænge', 'hængt', 'hærde', 'hæren', 'hærge', 'hætte', 'hævde', 'hæver',
'hæves', 'hævet', 'hævne', 'hævns', 'høfde', 'højde', 'højen', 'højes', 'højne', 'højre',
'højst', 'høker', 'høkre', 'hølæs', 'hønen', 'høner', "høns'", 'hønse', 'hører', 'høres',
'hørig', 'hørme', 'hørte', 'høste', 'høsts', 'høtyv', 'høved', 'høvle', "i'ers", "i'ets",
'ideal', 'ideel', 'ideen', 'ideer', 'idiom', 'idiot', 'idols', 'idræt', 'idyls', 'idéen',
'idéer', 'idømt', 'ifald', 'iføre', 'iført', 'iglen', 'igler', 'igles', 'iglos', 'ihjel',
'ikkun', 'ikons', 'ikten', 'ilbud', 'ilden', 'ilder', 'ildhu', 'ildne', 'ilede', 'iling',
'ilsom', 'ilten', 'ilter', 'iltet', 'iltog', 'iltre', 'image', 'imens', 'immer', 'immun',
'indad', 'indbo', 'inden', 'inder', 'indgå', 'indre', 'indse', 'indså', 'indsø', 'indvi',
'indøv', 'inert', 'infam', 'ingen', 'input', 'intet', 'intim', 'intro', 'inuit', 'ionen',
'ioner', 'irisk', 'ironi', 'irren', 'irret', 'irske', 'irøre', 'isbod', 'isbåd', 'isene',
'isens', 'isfri', 'ishav', 'ising', 'islag', 'islam', 'islom', 'islæg', 'islæt', 'ismer',
'issen', 'isser', 'isses', 'issyl', 'istap', 'ister', 'istid', 'istme', 'ivrer', 'ivrig',
"j'ers", "j'ets", 'jaden', 'jager', 'jages', 'jaget', 'jagte', 'jagts', 'jaket', 'jakke',
'jambe', 'jamen', 'jamme', 'jamre', 'jante', 'jappe', 'jarls', 'jaske', 'javel', "jazz'",
'jazze', 'jeans', 'jeeps', 'jeger', 'jeget', 'jenka', 'jente', 'jeres', 'jerns', 'jeton',
'jobbe', 'jodle', 'joges', 'jogge', 'joint', 'joken', 'joker', 'jokes', 'jokke', 'jolle',
'jolre', 'jonen', 'joner', 'jorde', 'jords', 'joule', 'jubel', 'juble', 'judas', 'juice',
"juks'", 'julen', 'juler', 'jules', 'julet', 'julis', 'jumbe', 'jumbo', 'jumpe', 'junge',
'junke', 'junta', 'jurys', 'juvel', 'jyden', 'jyder', 'jydes', 'jyske', 'jæger', 'jærpe',
'jærve', 'jærvs', 'jætte', 'jævne', 'jævnt', 'jøden', 'jøder', 'jødes', 'jøkel', "k'ers",
"k'ets", 'kabel', 'kable', 'kabys', 'kadet', 'kadre', 'kaffe', 'kagen', 'kager', 'kages',
'kagle', 'kahyt', 'kajak', 'kajen', 'kajer', 'kakao', 'kakis', 'kalas', 'kalde', 'kalds',
'kaldt', 'kalif', 'kalke', 'kalks', 'kalla', 'kalot', 'kalve', 'kalvs', 'kamel', 'kames',
'kamik', 'kamin', 'kamme', 'kampe', 'kamps', 'kamre', 'kamés', 'kanal', 'kande', 'kanel',
'kanen', 'kaner', 'kanes', 'kanin', 'kanon', 'kanos', 'kante', 'kants', 'kanut', 'kapel',
'kaper', 'kapok', 'kappe', 'kapre', 'kapun', 'kaput', 'karak', 'karat', 'karet', 'kargo',
'karle', 'karls', 'karma', 'karme', 'karms', 'karpe', 'karre', 'karry', 'karré', 'karse',
'karsk', 'karte', 'karve', 'kasak', 'kasko', 'kasse', 'kaste', 'kasts', 'kasus', 'katar',
'katte', 'kavaj', 'kaver', 'kebab', 'kedel', 'keder', 'kedes', 'kedet', 'kefir', 'kegle',
'kejse', 'kejte', 'kelim', 'kende', 'kendt', 'kerne', 'kerte', 'kerub', 'ketch', 'ketle',
'keton', 'khans', 'khmer', 'kigge', 'kikke', 'kikse', 'kilde', 'kilen', 'kiler', 'kiles',
'kilet', 'kilos', 'kilte', 'kilts', 'kimen', 'kimer', 'kimes', 'kimet', 'kimse', 'kinds',
'kinin', 'kinke', 'kinos', 'kiosk', 'kippe', 'kirke', 'kisel', 'kiste', 'kitin', 'kitte',
'kives', 'kiwis', 'kjole', 'kjove', 'klage', 'klamt', 'klang', 'klans', 'klaps', 'klare',
'klart', 'klase', 'klask', 'klavr', 'klejn', 'klemt', 'klerk', 'klike', 'klima', 'kline',
'kling', 'klink', 'klint', 'klips', 'klire', 'klits', 'kloak', 'klode', 'klods', 'kloen',
'kloge', 'klogt', 'klone', 'klore', 'klove', 'klovn', 'klovs', 'klubs', 'klude', 'kluds',
'klump', 'klumr', 'kluns', 'klunt', 'klyde', 'klyng', 'klynk', 'klæbe', 'klæde', 'klædt',
'klæge', 'kløen', 'kløer', 'kløet', 'kløft', 'kløgt', "kløs'", 'kløse', 'kløve', 'knage',
'knald', 'knaps', 'knapt', 'knark', 'knarr', 'knase', 'knast', 'knebl', 'knebr', 'knebs',
'knejs', 'knevr', 'knibe', 'kniks', 'knipl', 'knips', 'knirk', 'knitr', 'knive', 'knivs',
'knobe', 'knobs', 'knoen', 'knoer', 'knokl', 'knold', 'knops', 'knort', 'knubs', 'knude',
'knuge', 'knuse', 'knust', 'knyet', 'knyst', 'knæet', 'knægt', 'knæks', 'knæle', 'koala',
'koben', 'koble', 'kobra', 'koden', 'koder', 'kodes', 'kodet', 'koens', 'kofte', 'koger',
'koges', 'kogeø', 'kogge', 'kogle', 'kogte', 'koket', 'kokke', 'kokon', 'kokos', 'kokse',
'kolbe', 'kolde', 'koldt', 'kolik', 'kolli', 'kolon', 'kolos', 'komas', 'komet', 'komik',
'komma', 'komme', 'kondi', 'konen', 'koner', 'kones', 'konet', 'konge', 'konti', 'konto',
'konus', 'kopar', 'kopek', 'kopis', 'kopra', 'koral', 'koran', 'korde', 'koret', 'korne',
'korns', 'korps', 'korse', 'korso', 'korte', 'korts', 'kosak', 'koste', 'kosts', 'koter',
'koøje', 'kraal', 'krads', 'kraft', 'krage', 'kraks', 'krank', 'krans', 'krats', 'krave',
'kravl', 'kravs', 'krebs', 'kreds', 'kreer', 'krems', 'kremt', 'kreol', 'kreti', 'kribl',
'kridt', 'krige', 'krigs', 'krimi', 'krise', 'kroat', 'kroen', 'kroer', 'kroge', 'krogs',
'kroki', 'krone', 'krops', 'krudt', 'kruse', 'krybe', 'krybs', 'krydr', 'kryds', 'krymp',
'krypt', 'kråls', 'kråse', 'kræet', 'kræft', 'kræge', 'kræng', 'krænk', 'kræse', 'kræve',
'krøge', 'krøje', 'kubik', 'kubus', 'kuede', 'kugle', 'kujon', 'kukke', 'kukur', 'kulak',
'kulde', 'kulds', 'kulen', 'kuler', 'kules', 'kulet', 'kulos', 'kulso', 'kults', 'kulør',
'kumme', 'kunde', 'kunne', 'kunst', 'kupes', 'kuple', 'kupon', 'kuppe', 'kupés', 'kuren',
'kurer', 'kures', 'kuret', 'kurie', 'kurre', "kurs'", 'kurve', 'kurvs', 'kurér', 'kuske',
'kusks', 'kusse', 'kutte', 'kvads', 'kvaje', 'kvajs', 'kvalm', 'kvals', 'kvalt', 'kvant',
'kvark', 'kvart', 'kvase', 'kvast', 'kvide', 'kvien', 'kvier', 'kvies', 'kvikt', 'kvilt',
'kvint', 'kvist', 'kvota', 'kvote', 'kvæde', 'kvæge', 'kvægs', 'kvæld', 'kvæle', 'kværk',
'kværn', 'kvæst', 'kybel', 'kyler', 'kylet', 'kymre', 'kyper', 'kyras', 'kyrie', 'kysen',
'kyser', 'kyses', 'kysse', 'kyste', 'kysts', 'kåben', 'kåber', 'kåbes', 'kådes', 'kålen',
'kårde', 'kårer', 'kåres', 'kåret', 'kæben', 'kæber', 'kæbes', 'kæden', 'kæder', 'kædes',
'kædet', 'kæfte', 'kække', 'kælen', 'kæler', 'kælet', 'kælke', 'kælks', 'kælne', 'kælve',
'kæmme', 'kæmpe', 'kæppe', 'kærer', 'kæres', 'kæret', 'kærne', 'kærre', 'kærte', 'kævle',
'køber', 'købes', 'købet', 'købte', 'kødet', 'køens', 'køers', 'køjen', 'køjer', 'køjes',
'kølen', 'køler', 'køles', 'kølet', 'kølig', 'kølle', 'kølne', 'kønne', 'kører', 'køres',
'kørne', 'kørom', 'kørte', 'køter', "l'ers", "l'ets", 'laban', 'labbe', 'label', 'laber',
'labil', 'labre', 'laden', 'lader', 'lades', 'ladet', 'ladte', 'lagde', 'lagen', 'lager',
'lages', 'laget', 'lagre', 'lagte', 'lakaj', 'laker', 'lakke', 'lalle', 'lamas', 'lamel',
'lames', 'lamme', 'lampe', 'lamés', 'lande', 'lands', 'lange', 'langs', 'langt', 'lanse',
'lapin', 'lapis', 'lappe', "laps'", 'lapse', 'lapsk', 'large', 'largo', 'larme', 'larve',
'laser', 'laset', 'laske', 'lasso', 'laste', 'lasts', 'lasur', 'latex', 'latin', 'lavas',
'laven', 'laver', 'laves', 'lavet', 'lease', 'leben', 'leden', 'leder', 'ledes', 'ledet',
'ledig', 'ledte', 'leens', 'leers', 'lefle', 'legal', 'legat', 'legen', 'leger', 'leget',
'legio', 'lejde', 'lejen', 'lejer', 'lejes', 'lejet', 'lejre', 'lejrs', 'lemma', 'lemme',
'lempe', 'lemur', 'lenet', 'lento', 'leret', 'letal', 'lette', 'lever', 'levet', 'levit',
'levne', 'levns', 'levre', 'liden', 'lider', 'lidet', 'lidse', 'lidte', 'liens', 'liere',
'liers', 'lifte', 'lifts', 'ligas', 'liges', 'liget', 'ligge', 'light', 'ligne', 'likør',
'lilje', 'lilla', 'lille', 'limbo', 'limen', 'limer', 'limes', 'limet', 'limit', 'linde',
'lindr', 'linds', 'linen', 'liner', 'lines', 'linet', 'linje', 'links', 'linse', 'liren',
'lirer', 'lires', 'liret', 'lirke', 'lisen', 'lises', 'liste', 'liter', 'litra', 'liver',
'livet', 'livre', 'livré', 'lobbe', 'lobby', 'lodde', 'lodne', 'lodse', 'loens', 'loers',
'lofts', 'logen', 'loger', 'loges', 'logge', 'logik', 'login', 'logre', 'lokal', 'lokke',
'lokum', 'lomme', 'lomvi', 'longe', 'loope', 'loppe', 'loran', 'loren', 'losse', 'lotte',
'lotto', 'lotus', 'loven', 'lover', 'loves', 'lovet', 'loyal', 'lubbe', 'luden', 'luder',
'ludes', 'ludet', 'luens', 'luffe', 'lufte', 'lufts', 'lugar', 'lugen', 'luger', 'luges',
'luget', 'lugte', 'lugts', 'lukaf', 'lukke', 'lulle', 'lumen', 'lumpe', 'lumre', 'lumsk',
'lunch', 'lunde', 'lunds', 'luner', 'lunes', 'lunet', 'lunge', 'lunke', "luns'", 'lunte',
'lupin', 'luppe', 'lupus', 'luren', 'lurer', 'lures', 'luret', 'lusen', 'luset', 'luske',
'lutre', 'luven', 'lybsk', 'lyden', 'lyder', 'lydes', 'lydig', 'lyene', 'lyets', 'lygte',
'lykke', 'lymfe', 'lynch', 'lyner', 'lynet', 'lynne', 'lyren', 'lyrer', 'lyres', 'lyrik',
'lyser', 'lyses', 'lyset', 'lyske', 'lysne', 'lyste', 'lysår', 'lytte', 'lyver', 'lågen',
'låger', 'låges', 'låget', 'låner', 'lånes', 'lånet', 'lånte', 'låret', 'låsen', 'låser',
'låses', 'låset', 'låste', 'læben', 'læber', 'læbes', 'læder', 'lægds', 'lægen', 'læger',
'læges', 'lægge', 'lægte', 'lækat', 'lække', 'lækre', 'læmme', 'lænds', 'læner', 'lænes',
'lænet', 'længe', 'lænke', 'lænse', 'lærde', 'læren', 'lærer', 'læres', 'lærke', 'lærks',
'lærte', 'læser', 'læses', 'læske', 'læspe', 'læsse', 'læste', 'læsts', 'løber', 'løbes',
'løbet', 'løbsk', 'lødig', 'løfte', 'løget', 'løgne', 'løgns', 'løjen', 'løjer', 'løjes',
'løjet', 'løjpe', 'løkke', 'lønne', 'løsen', 'løser', 'løses', 'løsne', 'løste', 'løven',
'løver', 'løves', 'løvet', "m'ers", "m'ets", 'macho', 'macon', 'madam', 'maden', 'mader',
'madet', 'mafia', 'magen', 'mager', 'mages', 'magis', 'magma', 'magre', 'magte', 'magts',
'majer', 'majet', 'major', 'makke', 'makro', 'malaj', 'maler', 'malet', 'malke', 'malle',
'malme', 'malms', 'malte', 'malør', 'mamas', 'mambo', 'mande', 'mands', 'maner', 'manga',
'mange', 'mango', 'mangt', 'manis', 'manke', 'manko', 'manna', 'manne', 'manus', 'manér',
'maori', 'mappe', 'march', 'maren', 'marin', 'marks', 'marsk', 'marts', 'marve', 'maser',
'mases', 'maset', 'maske', 'masse', 'maste', 'masts', 'masut', 'match', 'maten', 'matte',
'maven', 'maver', 'maves', 'mavet', 'mayas', 'meden', 'meder', 'medes', 'medet', 'medgå',
'media', 'medie', 'medio', 'megen', 'meget', 'mejer', 'mejet', 'mejse', 'mejsl', 'mekka',
'melde', 'meldt', 'meler', 'melet', 'melis', 'melon', 'memos', 'mened', 'mener', 'menes',
'menet', 'menig', 'mente', 'menus', 'merit', 'merle', 'mesan', 'meson', 'messe', 'meste',
'metal', 'metan', 'meter', 'metra', 'metre', 'metro', 'metyl', 'mezzo', 'miave', 'miden',
'mider', 'mides', 'midje', 'midte', 'midti', 'mikro', 'mikse', 'milde', 'mildt', 'milen',
'miler', 'miles', 'miljø', 'mille', 'milte', 'milts', 'mimer', 'mimes', 'mimet', 'mimik',
'mimre', 'minde', 'minen', 'miner', 'mines', 'minke', 'minks', 'minus', 'minut', 'minør',
'misse', 'miste', 'mitra', 'mitte', 'mjave', 'mjøds', 'mobbe', 'mobil', 'modal', 'model',
'modem', 'moden', 'moder', 'modes', 'modet', 'modgå', 'modig', 'modne', 'modul', 'modus',
'moire', 'moiré', 'mokka', 'mokke', 'molbo', 'molen', 'moler', 'moles', 'molok', 'molær',
'monde', 'monne', 'moppe', "mops'", 'moral', 'mords', 'morel', 'moren', 'morer', 'moret',
'morse', 'mosen', 'moser', 'moses', 'moset', 'moske', 'moské', 'mosle', 'moste', 'motel',
'motet', 'motiv', 'motor', 'motto', 'mover', 'mudre', 'muffe', 'mufle', 'mufti', 'muger',
'muget', 'mugge', 'mugne', 'muhko', 'mukke', 'mulat', 'mulen', 'muler', 'mules', 'mulig',
'mulkt', 'mulle', 'multi', 'mumie', 'mumle', 'munde', 'munds', 'munke', 'munks', 'muren',
'murer', 'mures', 'muret', 'murre', 'musen', 'muser', 'muses', 'musik', 'musts', 'muzak',
'mynde', 'mynte', 'myose', 'myrde', 'myren', 'myrer', 'myres', 'myrra', 'myrte', 'mysli',
'myten', 'myter', 'mytes', 'måber', 'måbet', 'måden', 'måder', 'mådes', 'mågen', 'måger',
'måges', 'måler', 'måles', 'målet', 'målte', 'måned', 'månen', 'måner', 'månes', 'måsen',
'måses', 'måske', 'måtte', 'mæcen', 'mægle', 'mægte', 'mælde', 'mæler', 'mælet', 'mælke',
'mælks', 'mænds', 'mænge', 'mæren', 'mæres', 'mærke', 'mæske', 'mætte', 'møbel', 'møder',
'mødes', 'mødet', 'mødig', 'mødom', 'mødre', 'mødte', 'møens', 'møers', 'møffe', 'møges',
'møgso', 'mølle', 'mønbo', 'mønje', 'mønne', 'mønsk', 'mønte', 'mønts', 'mørke', 'mørkt',
'mørne', 'møver', 'møvet', "n'ers", "n'ets", 'nabob', 'nabos', 'nadir', 'nafta', 'nager',
'naget', 'nagle', 'naive', 'naivt', 'najer', 'najet', 'nakke', 'nappa', 'nappe', 'narko',
'narre', 'narve', 'narvs', 'nasal', 'nasse', 'natte', 'natur', 'naver', 'navet', 'navle',
'navne', 'navns', 'nazis', 'nedad', 'neden', 'nedis', 'nedom', 'nedre', 'neger', 'negle',
'negls', 'negre', 'nejer', 'nejet', 'nemme', 'nerie', 'nertz', 'nerve', 'netop', 'nette',
'netto', 'nevet', 'nevøs', 'niche', 'nidsk', 'niece', 'niere', 'niers', 'nikke', 'nippe',
'nipse', 'nisse', 'nital', 'nitid', 'nitte', 'niårs', 'niøje', 'nobel', 'noble', 'noden',
'noder', 'nodes', 'nogen', 'noget', 'nogle', 'nokke', 'noler', 'noles', 'nolet', 'nomen',
'nonet', 'nonne', 'noppe', 'nopre', 'noret', 'norms', 'norne', 'norsk', 'nosse', 'notar',
'notas', 'notat', 'noten', 'noter', 'notes', 'notet', 'nubre', 'nudel', 'nulre', 'nulte',
'numre', 'numse', 'nuppe', 'nurse', 'nusle', 'nusse', 'nutid', 'nuvel', 'nyder', 'nydes',
'nyere', 'nyest', 'nyhed', 'nykke', 'nylig', 'nylon', 'nymfe', 'nynne', 'nyren', 'nyrer',
'nyres', 'nyser', 'nyset', 'nysne', 'nysyn', 'nytid', 'nytte', 'nytår', 'nåden', 'nådig',
'nådle', 'nåede', 'nålen', 'nåles', 'næbes', 'næbet', 'nægte', 'nælde', 'nænne', 'næppe',
'nærer', 'næres', 'næret', 'nærig', 'nærme', 'nærpå', 'næsen', 'næser', 'næses', 'næste',
'næven', 'næver', 'næves', 'nævne', 'nævns', 'nævnt', 'nøden', 'nøder', 'nødet', 'nødig',
'nøfle', 'nøgen', 'nøgle', 'nøgne', 'nøjes', 'nøkke', 'nøler', 'nølet', 'nørde', 'nørke',
'nørkl', "o'ers", "o'ets", 'oasen', 'oaser', 'oases', 'oblat', 'oblik', 'oboen', 'oboer',
'obols', 'ocean', 'odden', 'odder', 'oddes', 'odens', 'oders', 'odiøs', 'odørs', 'offer',
'ofrer', 'ofres', 'ofret', 'okapi', 'okker', 'oksen', 'okser', 'okses', 'okset', 'oktan',
'oktav', 'oktet', 'olden', 'olien', 'olier', 'olies', 'oliet', 'olymp', 'ombud', 'ombuk',
'ombyg', 'omdøb', 'omega', 'omegn', 'omend', 'omgav', 'omgik', 'omgiv', 'omgås', 'omkom',
'omlyd', 'omløb', 'omsat', 'omtyd', 'omvej', 'onani', 'onder', 'ondes', 'ondet', 'onkel',
'onyks', 'opals', 'opart', 'opbag', 'opbud', 'opbyg', 'opdag', 'opera', 'opfat', 'opfed',
'opfej', 'opfør', 'opgav', 'opgiv', 'opgør', 'ophav', 'ophed', 'ophob', 'ophug', 'ophæv',
'ophøj', 'ophør', 'opiat', 'opium', 'opkog', 'opkøb', 'oplad', 'oplag', 'oplev', 'opliv',
'oplod', 'oplys', 'oplæg', 'opløb', 'opløs', 'opnår', 'opnås', 'opofr', 'opret', 'oprik',
'opråb', 'oprør', 'opsat', 'opslå', 'opstå', 'opsug', 'opsyn', 'opsøg', 'optag', 'optik',
'optog', 'optur', "opus'", 'opvej', 'opæde', 'opøve', 'orale', 'orden', 'ordet', 'ordne',
'ordre', 'organ', 'orgel', 'orgie', 'orkan', 'orker', 'orket', 'orkis', 'orlon', 'orlov',
'ormen', 'ormes', 'ornat', 'ornen', 'orner', 'ornes', 'oscar', 'osman', 'osten', 'ostes',
'ostet', 'otium', 'otter', 'ounce', 'ovale', 'oveni', 'overs', 'ovnen', 'ovnes', 'oxids',
'oxyds', "p'ers", "p'ets", 'p-hus', 'pacer', 'padde', 'padle', 'paffe', 'pagaj', 'pagen',
'pagts', 'paket', 'pakis', 'pakke', 'palen', 'palet', 'palle', 'palme', 'palpe', 'palæs',
'pampa', 'panda', 'pande', 'panel', 'panik', 'pante', 'pants', 'panty', 'papas', 'papil',
'papir', 'pappe', 'parat', 'parer', 'paria', 'parka', 'parks', 'parre', 'parti', 'parts',
'party', 'paryk', 'pasha', 'passe', 'passé', 'pasta', 'pater', 'pates', 'patio', 'patos',
'patte', 'patés', 'pauke', 'pause', 'paven', 'paver', 'paves', 'peber', 'pebet', 'pebre',
'pedal', 'pedel', 'pegen', 'peger', 'peget', 'pejle', 'pelse', 'pence', 'penge', 'penis',
'penne', 'penny', 'pensa', 'peppe', 'perle', 'perse', 'pesos', 'petit', 'pette', 'piano',
'piben', 'piber', 'pibes', 'pibet', 'pible', 'piffe', 'pifte', 'pigen', 'piger', 'piges',
'piget', 'pigge', 'pikes', 'pikke', 'pikés', 'pilaf', 'pilen', 'piles', 'pilke', 'pilks',
'pille', 'pilot', 'pimpe', 'pinde', 'pinds', 'pinen', 'piner', 'pines', 'pings', 'pinje',
'pinol', 'pinse', 'pinup', 'pippe', 'pique', 'piqué', 'pirat', 'pirke', 'pirks', 'pirog',
'pirol', 'pirre', 'piske', 'pisse', 'pists', 'piver', 'pivot', 'pixel', 'pizza', 'pjalt',
'pjank', 'pjask', 'pjece', 'pjevs', "pjus'", 'pjusk', 'pjæve', 'plade', 'plads', 'plage',
'plags', 'plaid', 'plane', 'plank', 'plano', 'plans', 'plant', 'plapr', 'plask', 'plast',
'plebs', 'pleje', 'plejl', 'pleti', 'pligt', 'plint', 'plire', 'plove', 'plovs', 'pludr',
'plump', 'plumr', 'plums', 'plæne', 'pløje', 'pløre', 'poche', 'poden', 'poder', 'podes',
'podet', 'poesi', 'poets', 'point', 'poise', 'pokal', 'poker', 'polak', 'polar', 'polen',
'poler', 'polet', 'polio', 'polka', 'polos', 'polsk', 'polyp', 'polær', 'pomet', 'ponto',
'ponys', 'pools', 'poppe', 'poren', 'porer', 'pores', 'poret', 'porno', 'porre', 'porse',
'porte', 'porto', 'ports', 'porøs', 'posen', 'poser', 'poses', 'poset', 'poste', 'posts',
'posør', 'poten', 'poter', 'potes', 'potte', 'power', 'pragt', 'praje', 'prajs', 'prale',
'prang', 'prate', 'prent', "pres'", 'prima', 'prime', 'primo', 'prims', 'prins', 'print',
'prior', "pris'", 'prise', 'prods', 'props', 'prosa', 'provo', 'prunk', 'prust', 'pryde',
'prygl', 'præer', 'præet', 'præge', 'prægs', 'præke', 'præst', 'prøve', 'psyke', 'pucks',
'puden', 'puder', 'pudes', 'pudre', "puds'", 'pudse', 'puffe', 'puger', 'puget', 'pukke',
'pukle', 'pulje', 'pulle', 'pulse', 'pulte', 'pults', 'pumas', 'pumpe', 'pumps', 'punch',
'punds', 'punge', 'pungs', 'punks', 'punkt', 'pupil', 'puppe', 'pures', 'purke', 'purks',
'purre', 'purse', 'purés', 'pusle', 'puste', 'pusts', 'putte', 'pygmæ', 'pylre', 'pynte',
'pynts', 'pyton', 'påbud', 'pådut', 'pågår', 'påhit', 'påhør', 'påkær', 'pålæg', 'påløb',
'påpeg', 'påsat', 'påser', 'påske', 'påstå', 'påsyn', 'påtag', 'påtår', 'pægle', 'pælen',
'pæles', 'pæons', 'pæren', 'pærer', 'pæres', 'pøbel', 'pølle', 'pølse', 'pønse', "q'ers",
"q'ets", 'quilt', "r'ers", "r'ets", 'rabat', 'rabbi', 'rable', 'racen', 'racer', 'races',
'racet', 'radar', 'raden', 'rader', 'radio', 'radix', 'radon', 'radså', 'rafle', 'rafte',
'ragas', 'rager', 'raget', 'raids', 'rajah', 'raket', 'rakke', 'rakle', 'rakte', 'ralle',
'rally', 'ramle', 'ramme', 'rampe', 'ramte', 'ranch', 'rande', 'rands', 'randt', 'raner',
'ranet', 'range', 'rangs', 'ranke', 'rapid', 'rappe', 'rapse', 'rasen', 'raser', 'raset',
'raske', 'raskt', 'rasle', 'raspe', 'raste', 'rasts', 'rasur', 'raten', 'rater', 'rates',
'ratio', 'raver', 'ravet', 'ravne', 'ravns', 'rayon', 'rebel', 'reber', 'rebes', 'rebet',
'rebus', 'reces', 'recks', 'redde', 'reden', 'reder', 'redes', 'redet', 'redte', 'reelt',
'regal', 'regel', 'reger', 'regne', 'rejen', 'rejer', 'rejes', 'rejfe', 'rejfs', 'rejse',
'rejst', 'rekyl', 'remis', 'remme', 'remse', 'rende', 'rendt', 'renen', 'rener', 'rense',
'rente', 'reols', 'repos', 'rests', 'retor', 'rette', 'retur', 'reven', 'revet', 'revir',
'revle', 'revne', 'revse', 'revys', 'ribbe', "ribs'", 'riden', 'rider', 'rides', 'ridse',
'ridts', 'rifts', 'rigel', 'riger', 'riges', 'riget', 'rigge', 'rigid', 'rigle', 'rille',
'rimen', 'rimer', 'rimes', 'rimet', 'rimpe', 'rimte', 'rinde', 'ringe', 'rings', 'rinke',
'rippe', 'risen', 'rises', 'risle', 'rispe', 'riste', 'rists', 'ritte', 'ritus', 'rival',
'riven', 'river', 'rives', 'roben', 'rober', 'robes', 'robot', 'robåd', 'rocke', 'rocks',
'roden', 'rodeo', 'roder', 'rodes', 'rodet', 'roede', 'roens', 'roere', 'roers', 'roker',
'rokke', 'rolig', 'rolle', 'roman', 'rombe', 'romer', 'rommy', 'rondo', 'roret', 'rosen',
'roser', 'roses', 'roset', 'rosin', 'roste', 'roter', 'rotor', 'rotte', 'rotur', 'rouge',
'rover', 'rovet', 'rovse', 'royal', 'rubbe', 'rubel', 'rubin', 'ruche', 'rudel', 'ruden',
'ruder', 'rudes', 'rudet', 'rufle', 'rugby', 'ruger', 'ruget', 'ruins', 'rulam', 'rulle',
'rumba', 'rumle', 'rumme', 'rumpe', 'runde', 'rundt', 'runen', 'runer', 'runes', 'runge',
'rupis', 'rural', 'rusen', 'ruser', 'ruses', 'ruske', 'ruste', 'ruten', 'ruter', 'rutes',
'rutsj', 'rutte', 'ryaen', 'ryaer', 'rydde', 'ryger', 'rygge', 'rygte', 'rykke', 'rylen',
'ryler', 'ryles', 'rynke', 'rypen', 'ryper', 'rypes', 'ryste', 'rytme', 'råben', 'råber',
'råbes', 'råbet', 'råbte', 'råbuk', 'råder', 'rådes', 'rådet', 'rådig', 'rådne', 'rådyr',
'råens', 'råers', 'rågen', 'råger', 'råges', 'råhed', 'råhus', 'råkid', 'rålam', 'rånok',
'råtræ', 'ræbet', 'række', 'rælig', 'rænke', 'ræret', 'ræser', 'ræset', 'ræson', 'ræves',
'røber', 'røbet', 'rødme', 'rødne', 'røfle', 'røgen', 'røger', 'røges', 'røget', 'røgte',
'rømme', 'rønne', 'rører', 'røres', 'røret', 'rørig', 'rørte', 'røræg', 'røsen', 'røser',
'røses', 'røsti', 'røsts', 'røven', 'røver', 'røves', 'røvet', "s'ers", "s'ets", 'sabel',
'sable', 'sadel', 'sadhu', 'sadle', 'safir', 'safte', 'safts', 'sagas', 'sagde', 'sagen',
'sager', 'sagns', 'sagte', 'sakke', "saks'", 'sakse', 'salat', 'saldo', 'salen', 'salep',
'sales', 'salgs', 'salig', 'salme', 'salon', 'salpe', 'salsa', 'salte', 'salto', 'salts',
'salut', 'salve', 'salær', 'samba', 'sambo', 'samen', 'samer', 'sames', 'samle', 'samme',
'samsk', 'samsø', 'sande', 'sandt', 'saner', 'sange', 'sangs', 'sanke', 'sanse', 'sarge',
'sargs', 'saris', 'sarte', 'satan', 'satin', "sats'", 'satse', 'satte', 'satyr', 'sauce',
'sauna', 'saven', 'saver', 'saves', 'savet', 'savle', 'savne', 'savns', 'saxen', 'saxer',
'scene', 'scoop', 'score', 'sedan', 'sedes', 'seede', 'seere', 'seers', 'segle', 'segls',
'segne', 'sejen', 'sejer', 'sejes', 'sejle', 'sejls', 'sejre', 'sejrs', 'sejse', 'sekel',
"seks'", 'sekst', 'sekts', 'selen', 'seler', 'seles', 'selve', 'semit', 'senat', 'sende',
'sendt', 'senen', 'sener', 'senes', 'senet', 'senge', 'sengs', 'senil', 'sepia', 'seraf',
'serge', 'serie', 'serum', 'serve', 'serøs', 'sesam', 'sexet', 'sfære', 'shahs', 'sheik',
'shiit', 'shine', 'shows', 'shunt', 'siben', 'sidde', 'siden', 'sider', 'sides', 'sidse',
'sidst', 'siede', 'siens', 'siers', 'sifon', 'sigel', 'siger', 'siges', 'sigma', 'signe',
'sigte', 'sikhs', 'sikke', 'sikre', 'silde', 'silds', 'silen', 'siler', 'silet', 'silke',
'silos', 'silur', 'simle', 'simre', 'simse', 'sinde', 'sinds', 'sinke', 'sinus', 'sioux',
'sippe', 'sirat', 'sirer', 'siret', 'sirts', 'sirup', 'sisal', 'sitar', 'sitre', 'siven',
'siver', 'sives', 'sivet', 'sjals', 'sjask', 'sjavs', 'sjofl', 'sjosk', 'sjove', 'sjovt',
'sjuft', 'sjusk', 'sjækl', 'sjæle', 'sjæls', 'skabe', 'skabs', 'skabt', 'skade', 'skaft',
'skage', 'skakt', 'skala', 'skalk', 'skalp', 'skals', 'skalt', 'skank', 'skare', 'skarn',
'skarp', 'skarv', 'skats', 'skave', 'skede', 'skeen', 'skeer', 'skeje', 'skejs', 'skele',
'skeln', 'skels', 'skema', 'skete', 'skibe', 'skibs', 'skide', 'skids', 'skidt', 'skift',
'skilt', 'skiml', 'skimt', 'skind', 'skins', 'skive', 'skjul', 'skoen', 'skogr', 'skold',
'skole', 'skose', 'skove', 'skovl', 'skovs', 'skrab', 'skral', 'skrap', 'skrat', 'skred',
'skreg', 'skrev', 'skrig', 'skrin', 'skriv', 'skrog', 'skrot', 'skrub', 'skrud', 'skrue',
'skruk', 'skrus', 'skrut', 'skryd', 'skrål', 'skrån', 'skrås', 'skråt', 'skræk', 'skræl',
'skræp', 'skræv', 'skrød', 'skude', 'skudt', 'skuer', 'skues', 'skuet', 'skule', 'skulk',
'skunk', 'skure', 'skurk', 'skurs', 'skurv', 'skvat', 'skvis', 'skvæt', 'skyde', 'skyen',
'skyer', 'skyet', 'skyld', 'skynd', 'skyts', 'skåle', 'skåls', 'skåne', 'skårs', 'skæft',
'skægt', 'skæld', 'skælm', 'skæls', 'skælv', 'skæmt', 'skænd', 'skæne', 'skænk', 'skære',
'skærf', 'skærm', 'skærs', 'skærv', 'skæve', 'skævt', 'skøde', 'skøds', 'skøge', 'skønt',
'skøre', 'skørt', 'sladr', 'slags', 'slagt', 'slang', 'slank', 'slant', 'slapt', 'slask',
'slave', 'slems', 'slemt', 'slesk', 'sleve', 'slevs', 'slibe', 'slide', 'slids', 'slidt',
'slige', 'sligt', 'slime', 'slips', 'slisk', 'slots', 'slubr', 'slude', 'sluge', 'slugt',
"sluk'", 'slukn', 'slump', 'slumr', 'slurk', 'sluse', 'slyng', 'slåen', 'slåer', 'slået',
'slæbe', 'slæbs', 'slæbt', 'slæde', 'slægt', 'slæng', 'sløjd', 'sløje', 'sløjf', 'sløjt',
'sløre', 'sløse', 'sløve', 'sløvt', 'smage', 'smags', 'smagt', 'smalt', 'smart', 'smash',
'smask', 'smede', 'smeds', 'smelt', 'smide', 'smidt', 'smige', 'smigs', 'smile', 'smils',
'smisk', 'smock', 'smovs', "sms'e", 'smuds', 'smugl', 'smukt', 'smuld', 'smule', 'smult',
'smurt', 'smyge', 'småby', 'smæde', 'smægt', 'smæld', 'smøge', 'smøgs', 'smøle', 'smøls',
'smøre', 'smørs', 'snack', 'snage', 'snaps', 'snare', 'snart', 'snask', 'snavs', 'sneen',
'sneet', 'snegl', 'snerp', 'snert', 'snese', 'snige', 'snild', 'snipe', 'snips', 'snits',
'snive', 'snoet', 'snoge', 'snogs', 'snold', 'snore', 'snork', 'snors', 'snude', 'snuer',
'snuet', 'snuse', 'snusk', 'snyde', 'snyds', 'snydt', 'snylt', 'snære', 'snært', 'snøft',
'snøre', 'snøvl', 'snøvs', 'sober', 'sobre', 'soder', 'sodet', 'soens', 'sofas', 'sogne',
'sogns', 'soire', 'soiré', 'solde', 'solds', 'solen', 'soler', 'soles', 'solet', 'solgt',
'solid', 'solos', 'solur', 'solår', 'somme', 'somre', 'sonar', 'sonde', 'soner', 'sonet',
'sonor', 'soppe', 'sorgs', 'sorte', 'sorts', 'soten', 'soter', 'sound', 'sover', 'sovet',
'sovse', 'spade', 'spage', 'spagt', 'spalt', 'spand', 'spang', 'spank', 'spant', 'spare',
'spark', 'spars', 'speed', 'spege', 'spejl', 'spelt', 'sperm', "spex'", 'spids', 'spild',
'spile', 'spils', 'spind', 'spink', 'spion', 'spire', 'spirs', 'spise', 'spist', 'spjæt',
'splid', 'split', 'spole', 'spore', 'spors', 'sport', 'spots', 'spove', 'sprak', 'spray',
'sprit', 'sprog', 'sprut', 'spryd', 'spræl', 'spræt', 'sprød', 'spule', 'spuns', 'spurt',
'spurv', 'spyds', 'spået', 'spåns', 'spæde', 'spædt', 'spæge', 'spænd', 'spæne', 'spærs',
'spøge', 'spøjs', 'spørg', 'squaw', 'stabe', 'stabs', 'stade', 'stads', 'stage', 'stags',
'stald', 'stamp', 'stand', 'stang', 'stank', 'start', 'stase', 'stats', 'stave', 'stavn',
'stavs', 'steak', 'stede', 'steds', 'stedt', 'stege', 'stegs', 'stegt', 'stejl', 'stele',
'stels', 'stemt', 'stene', 'stens', 'stevs', 'stien', 'stier', 'stift', 'stige', 'stile',
'stilk', 'still', 'stils', 'stime', 'stiml', 'stind', 'sting', 'stink', 'stive', 'stivn',
'stjal', 'stofs', 'stola', 'stole', 'stolp', 'stols', 'stolt', 'store', 'stork', 'storm',
'stort', 'story', 'stose', 'stovt', 'straf', 'stram', 'stred', 'streg', 'strib', 'strid',
'strik', 'strop', 'strut', 'stryg', 'strås', 'stræb', 'stræk', 'strøg', 'strøm', 'strør',
'strøs', 'stude', 'studs', 'stuen', 'stuer', 'stues', 'stuks', 'stump', 'stumt', 'stund',
'stunt', 'stuts', 'stuve', 'stygt', 'stylt', 'styne', 'styre', 'styrk', 'styrs', 'styrt',
'ståbi', 'stået', 'ståls', 'stænk', 'stære', 'stærk', 'stærs', 'stævn', 'støbe', 'støbt',
'støde', 'støds', 'stødt', 'støje', 'støre', 'størs', 'støve', 'støvl', 'støvs', 'suder',
'sudle', 'suger', 'suges', 'suget', 'suite', 'sujet', 'sukat', 'sukke', 'sukre', 'sulen',
'suler', 'sules', 'sulet', 'sulfo', 'sulky', 'sulte', 'sumak', 'summe', 'sumpe', 'sumps',
'sunde', 'sunds', 'super', 'suppe', 'surfe', 'surre', 'susen', 'suser', 'suset', 'sushi',
'sutte', 'sutur', 'svada', 'svage', 'svagt', 'svaje', 'svajs', 'svale', 'svamp', 'svane',
'svang', 'svans', 'svare', 'svars', 'svede', 'sveds', 'svedt', 'svejf', 'svejs', 'svend',
'svide', 'svien', 'svier', 'svies', 'svige', 'svigt', 'svime', 'svind', 'svine', 'sving',
'svins', 'svips', 'svire', 'svirp', 'svits', 'svovl', 'svulm', 'svælg', 'sværd', 'svære',
'sværm', 'sværs', 'svært', 'svæve', 'svævs', 'svøbe', 'svøbs', 'svøbt', 'swing', 'syden',
'syder', 'sydes', 'sydet', 'sydom', 'sydpå', 'syede', 'syere', 'syers', 'sygen', 'syger',
'syges', 'sygne', 'sylen', 'syles', 'sylfe', 'sylte', 'synde', 'synds', 'syner', 'synes',
'synet', 'synge', 'synke', 'synsk', 'synål', 'syren', 'syrer', 'syres', 'syret', 'syrne',
'sysle', 'sytøj', 'syver', 'syvti', 'sådan', 'såede', 'sågar', 'sålen', 'såler', 'såpas',
'sårer', 'såres', 'såret', 'såsom', 'såten', 'såter', 'såvel', 'sæben', 'sæber', 'sæbes',
'sæbet', 'sæden', 'sæder', 'sædes', 'sædet', 'sække', 'sælen', 'sæler', 'sælge', 'sænke',
'sænks', 'særbo', 'særke', 'særks', 'sæson', 'sæter', 'sætte', 'søber', 'søbet', 'søder',
'sødet', 'sødme', 'søens', 'søers', 'søgen', 'søger', 'søges', 'søgte', 'søjle', 'søler',
'sølet', 'sølje', 'sølle', 'sølvs', 'sømil', 'sømme', 'søren', 'søret', 'sørge', 'sørme',
'søsat', 'søsyg', 'søulk', 'søvej', "t'ers", "t'ets", 'tabel', 'taber', 'tabes', 'tabet',
'tabte', 'tabus', 'tacos', 'tafts', 'tager', 'tages', 'taget', 'tajga', 'takke', 'takle',
'taksi', 'takst', 'takts', 'talar', 'talen', 'taler', 'tales', 'talje', 'talks', 'talon',
'talte', 'tamil', 'tamme', 'tampe', 'tamps', 'tande', 'tands', 'tanga', 'tange', 'tango',
'tangs', 'tanke', 'tanks', 'tante', 'tapen', 'tapet', 'tapir', 'tappe', 'tapre', 'taras',
'tarer', 'tarif', 'tarme', 'tarms', 'tarok', 'tarse', 'taske', 'taste', 'tasts', 'tatar',
'tater', 'taven', 'taver', 'tavet', 'tavle', 'tavse', 'tavst', 'taxas', 'taxie', 'tazet',
'teams', "tee's", 'teens', 'teers', 'tegne', 'tegns', 'teint', 'teist', 'tejne', 'tejst',
'tekno', 'tekop', 'tekst', 'telex', 'telte', 'telts', 'temas', 'tempi', 'tempo', 'tenen',
'tenes', 'tenor', 'teori', 'terme', 'terms', 'terne', 'terpe', 'terre', "ters'", 'terts',
'tesen', 'teser', 'teses', 'tesis', 'teske', 'teste', 'tests', 'teten', 'thais', 'thybo',
'tiara', 'tiden', 'tider', 'tiere', 'tiers', 'tiest', 'tiger', 'tigge', 'tigre', 'tikke',
'tilde', 'tilgå', 'tilse', 'tilså', 'tilte', 'timen', 'timer', 'times', 'timid', 'tinde',
'tinge', 'tings', 'tinte', 'tipis', 'tippe', "tips'", 'tirre', 'tiske', 'tisse', 'tital',
'titan', 'titel', 'titte', 'tiårs', 'tiøre', 'tjald', 'tjalk', 'tjans', 'tjavs', 'tjene',
'tjent', 'tjept', 'tjurs', 'tjære', 'tjørn', 'toast', 'tobak', 'tobis', 'toddy', 'toere',
'toers', 'tofte', 'togas', 'toges', 'toget', 'togts', 'tolde', 'tolke', 'tolks', 'tomat',
'tomle', 'tomme', 'tomts', 'tonal', 'tonen', 'toner', 'tones', 'tonet', 'tonic', 'topas',
'toppe', 'topti', 'toras', 'tordn', 'torne', 'torns', 'torps', 'torsk', 'torso', 'torve',
'torvs', 'tosse', 'total', 'totem', 'totne', 'totte', 'totur', 'touch', 'toupe', 'toupé',
'touts', 'tover', 'toves', 'tovet', 'toårs', 'toøre', 'trace', 'tracé', 'tragt', 'trake',
'traké', 'tramp', 'trane', 'trang', 'trask', 'trave', 'travl', 'travs', 'trawl', 'treer',
'trema', 'trend', 'trens', 'treti', 'trevl', 'trias', 'trick', 'triml', 'trind', 'trine',
'trins', 'triol', 'trios', 'trist', 'trivi', 'triør', 'trods', 'troen', 'troet', 'trofæ',
'trokl', 'trokæ', 'trold', 'trone', 'trope', 'trops', 'truck', 'truer', 'truet', 'trugs',
'trumf', 'trust', 'trygl', 'trygt', 'trykt', 'tryne', 'tråde', 'tråds', 'trådt', 'træde',
'træer', 'træet', 'træge', 'trægt', 'træls', 'træne', 'træsk', 'trævl', 'trøje', 'trøst',
'tsars', 'tubas', 'tuben', 'tuber', 'tubes', 'tuden', 'tuder', 'tudes', 'tudet', 'tudse',
'tuens', 'tuers', 'tugte', 'tujas', 'tukan', 'tulle', 'tulre', 'tumbl', 'tumle', 'tumor',
'tuner', 'tunet', 'tunge', 'tungt', 'turbo', 'turde', 'turen', 'turer', 'tures', 'turet',
'turne', 'turné', 'tusch', 'tuske', 'tusse', 'tutor', 'tutte', 'tutti', 'tvang', 'tvebo',
'tvege', 'tvine', 'tvist', 'tvivl', 'tvære', 'tværs', 'tvært', 'tweed', 'twill', 'twist',
'tyder', 'tydet', 'tyfon', 'tyfus', 'tygge', 'tykke', 'tykne', 'tylle', 'tylvt', 'tynde',
'tyndt', 'tynge', 'typen', 'typer', 'types', 'tyran', 'tyren', 'tyrer', 'tyres', 'tyret',
'tyrks', 'tyske', 'tysks', 'tysse', 'tyste', 'tyven', 'tyver', 'tyves', 'tyvte', 'tåben',
'tåber', 'tåbes', 'tågen', 'tåger', 'tåget', 'tåled', 'tåler', 'tåren', 'tårer', 'tåres',
'tårne', 'tårns', 'tæfte', 'tæfts', 'tægen', 'tæger', 'tæges', 'tække', 'tælle', 'tæmme',
'tænde', 'tændt', 'tænke', 'tænkt', 'tæppe', 'tærer', 'tæres', 'tæret', 'tærsk', 'tærte',
'tæske', 'tætne', 'tætte', 'tæven', 'tæver', 'tæves', 'tævet', 'tøffe', 'tøfle', 'tøjer',
'tøjet', 'tøjle', 'tøjre', 'tøjrs', 'tøjte', 'tømme', 'tømre', 'tømte', 'tønde', 'tøris',
'tørke', 'tørne', 'tørns', 'tørre', 'tørst', 'tøsen', 'tøser', 'tøset', 'tøsne', 'tøven',
'tøver', "u'ers", "u'ets", 'uanet', 'ublid', 'ubåde', 'ubåds', 'udarm', 'udbad', 'udben',
'udbor', 'udbud', 'udbul', 'udbyg', 'uddød', 'uddør', 'udelt', 'udfor', 'udfri', 'udgav',
'udgik', 'udgiv', 'udgås', 'udgør', 'udhal', 'udhug', 'udhul', 'udhus', 'udhæv', 'udjag',
'udkig', 'udkik', 'udkog', 'udkom', 'udkår', 'udlad', 'udlej', 'udlov', 'udlud', 'udlyd',
'udlån', 'udlæg', 'udløb', 'udløs', 'udmaj', 'udnyt', 'udpeg', 'udpos', 'udriv', 'udrug',
'udråb', 'udrøj', 'udsat', 'udsav', 'udset', 'udson', 'udspy', 'udstå', 'udsug', 'udsyn',
'udsyr', 'udsæd', 'udsæt', 'udtag', 'udtap', 'udtog', 'udtur', 'udtyd', 'udtær', 'udvej',
'udvid', 'udvis', 'udyds', 'udyrs', 'udånd', 'udæsk', 'udøbt', 'udørk', 'udøse', 'udøve',
'uegal', 'uenig', 'ufiks', 'ufine', 'ufred', 'ufødt', 'uføre', 'ugens', 'ugers', 'ugift',
'uglen', 'ugler', 'ugles', 'ugræs', 'uheld', 'uhyre', 'uhørt', 'ujævn', 'uklar', 'uklog',
'uland', 'ulave', 'ulden', 'uldet', 'uldne', 'ulige', 'ulken', 'ulkes', 'ultra', 'ulven',
'ulves', 'ulyst', 'ulærd', 'ulæst', 'uløst', 'umage', 'umbra', 'umild', 'under', 'undes',
'undgå', 'undre', 'undse', 'undså', 'undte', 'ungen', 'unger', 'unges', 'ungmø', 'unika',
'unikt', 'union', 'unode', 'unsen', 'unser', 'unses', 'unåde', 'urban', 'urede', 'uredt',
'ureel', 'urene', 'urent', 'urets', 'urger', 'urkok', 'urnen', 'urner', 'urnes', 'uroen',
'uroer', 'urrem', 'urten', 'urter', 'urtid', 'urund', 'uræmi', 'urørt', 'usagt', 'usand',
'usete', 'usket', 'uskik', 'uskøn', 'ussel', 'usund', 'utals', 'utalt', 'utide', 'uting',
'utopi', 'utryg', 'utugt', 'uvane', 'uvant', 'uvejr', 'uvens', 'uvist', 'uvorn', 'uåret',
'uægte', 'uøvet', "v'ers", "v'ets", 'vabel', 'vable', 'vaden', 'vader', 'vades', 'vadet',
'vager', 'vagts', 'vajer', 'vajet', 'vakle', 'vakse', 'vakte', 'valen', 'valgs', 'valgt',
'valid', 'valke', 'valle', 'valme', 'valse', 'valsk', 'valte', 'valør', 'vampe', 'vamps',
'vande', 'vandr', 'vands', 'vandt', 'vanen', 'vaner', 'vanes', 'vange', 'vangs', 'vanke',
'vanry', 'vante', 'vanær', 'varan', 'varde', 'varen', 'varer', 'vares', 'varet', 'varia',
'varig', 'varme', 'varmt', 'varpe', 'varsl', 'varte', 'varyl', 'vasal', 'vasen', 'vaser',
'vases', 'vaske', 'vasks', 'vater', 'vatre', 'vedet', 'vedgå', 'veens', 'veers', 'veget',
'vegne', 'vejen', 'vejer', 'vejes', 'vejet', 'vejle', 'vejre', 'vejrs', 'veksl', 'velan',
'velar', 'velin', 'velær', 'vemod', 'vende', 'vendt', 'venen', 'vener', 'venes', 'vente',
'venøs', 'verfe', 'verpe', "vers'", 'verst', 'verve', 'vesir', 'veste', 'vests', 'vetoe',
'viben', 'viber', 'vibes', 'vidde', 'viden', 'video', 'vides', 'vidje', 'vidne', 'vidst',
'vifte', 'vigen', 'viger', 'viges', 'vigte', 'vigør', 'vikar', 'vikke', 'vikle', 'vikse',
'vilde', 'vildt', 'vilje', 'villa', 'ville', 'vimre', 'vimse', 'vinca', 'vinde', 'vinds',
'vinen', 'vines', 'vinge', 'vinke', 'vinks', 'vinyl', 'vinøs', 'viola', 'viols', 'vippe',
'virak', 'viril', 'virke', 'virre', 'virus', 'visen', 'viser', 'vises', 'visir', 'visit',
'viske', 'visne', 'visse', 'viste', 'visum', 'visér', 'vital', 'vivat', 'vlies', 'vodka',
'vogne', 'vogns', 'vogte', 'voila', 'voile', 'vokal', 'vokse', 'volde', 'volds', 'voldt',
'volfe', 'volte', 'volut', 'vorde', 'vores', 'vorte', 'votum', 'voven', 'vover', 'voves',
'vovet', 'vovse', 'vrage', 'vrags', 'vralt', 'vrang', 'vrede', 'vredt', 'vride', 'vrist',
'vråle', 'vræle', 'vræls', 'vræng', 'vrøvl', 'vugge', 'vulst', 'vunde', 'vuppe', 'vupti',
'vyets', 'våben', 'vådte', 'vågen', 'våger', 'våges', 'våget', 'vågne', 'vånde', 'våren',
'våret', 'våser', 'våset', 'væbne', 'vædde', 'væden', 'væder', 'vædet', 'vædre', 'vægen',
'væger', 'væges', 'vægge', 'vægre', 'vægte', 'vægts', 'vægur', 'vække', 'vækst', 'vælde',
'vælge', 'vælig', 'vælsk', 'vælte', 'vænge', 'vænne', 'værdi', 'væren', 'været', 'værft',
'værge', 'værke', 'værks', 'værne', 'værns', 'værre', 'værst', 'værts', 'væsel', 'væsen',
'væske', 'vætte', 'væven', 'væver', 'væves', 'vævet', 'vævre', 'vølve', "w'ers", "w'ets",
'wagon', 'whist', 'wiren', 'wirer', "x'ers", "x'ets", 'xenon', "y'ers", "y'ets", 'yacht',
'yatzy', 'ydede', 'ydere', 'yders', 'ydmyg', 'ydrer', 'ydres', 'ydret', 'ymere', 'ymers',
'ympen', 'ymper', 'ympes', 'ympet', 'ymter', 'ymtet', 'ynder', 'yndet', 'yndig', 'yngel',
'yngle', 'yngre', 'yngst', 'ynker', 'yogis', 'yoyos', 'ypern', 'yppes', 'yppig', 'yrker',
'yrkes', 'yrket', 'ytrer', 'ytres', 'ytret', "z'ers", "z'ets", 'zambo', 'zappe', 'zaren',
'zarer', 'zebra', 'zebus', 'zefyr', 'zelot', 'zenit', 'zinks', 'zloty', 'zobel', 'zombi',
'zonen', 'zoner', 'zones', 'zooen', 'zooer', 'zoome', 'zooms', 'zulus', 'zweck', 'ågots',
'åland', 'åmund', 'århus', 'øjlug', 'øland', 'ølgod', 'ørbæk', 'ørnis', 'øssur', 'østen',
'øster', 'øvlis', "å'ers", "å'ets", 'åbent', 'åbner', 'åbnes', 'åbnet', 'ådale', 'ådsel',
'åerne', 'ågene', 'ågets', 'ålene', 'ålens', 'åløbs', 'ånden', 'ånder', 'åndes', 'åndet',
'åndig', 'årbog', 'årene', 'årens', 'årers', 'årets', 'årige', 'åring', 'årlig', 'årsag',
'årsko', 'årtis', 'åsene', 'åsted', 'åsyns', "æ'ers", "æ'ets", 'æbler', 'æbles', 'æblet',
'ædelt', 'ædens', 'ædere', 'æderi', 'æders', 'ædets', 'æggen', 'ægger', 'ægges', 'ægget',
'ægide', 'ægten', 'ægter', 'ægtes', 'ægtet', 'ælder', 'ældet', 'ældre', 'ældst', 'ælter',
'æltes', 'æltet', 'ænder', 'ændre', 'ængst', 'ænser', 'ænset', 'æonen', 'æoner', 'æraen',
'æraer', 'ærbar', 'ærede', 'ærens', 'ærers', 'ærgre', 'ærlig', 'ærmer', 'ærmes', 'ærmet',
'ærten', 'ærter', 'ærøbo', 'ærøsk', 'æsels', 'æsken', 'æsker', 'æskes', 'æsket', 'æsler',
'æslet', 'æstet', 'ætere', 'æters', 'ætser', 'ætset', 'ætyls', 'ævler', 'ævlet', 'ævred',
"ø'ers", "ø'ets", 'øboen', 'øboer', 'ødems', 'ødere', 'øders', 'ødets', 'ødsel', 'ødsle',
'øerne', 'øffet', 'øgede', 'øgene', 'øgets', 'øglen', 'øgler', 'øgles', 'øjets', 'øjner',
'øjnet', 'øksen', 'økser', 'økses', 'økset', 'ølbas', 'ølejr', 'øllen', 'øller', 'ølles',
'øllet', 'ømhed', 'ønske', 'ørene', 'ørens', 'ørers', 'ørets', 'ørige', 'ørken', 'ørler',
'ørnen', 'ørnes', 'ørred', 'øsens', 'øsers', 'øsken', 'østat', 'østen', 'østom', 'østpå',
'østre', 'østud', 'øvede', 'øvrig'];
